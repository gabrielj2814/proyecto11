<?php
    ...
    if(!(isset($_SESSION["nombre_usuario_software"]))){
        ...
        $menu_actual="udc";
        $submenu_actual="udc_captacion";
        $seccion_comentarios = $comentarios['udc_captacion'];//mis cuotas
        $demo_seccion = $demo['udc_captacion'];
        $nombre_pestana_navegador='UDC';
...
<title><?php echo $nombre_pestana_navegador;?> | Captación</title>
...
#tabla_jugadores_seguimiento thead tr th {
    text-transform: uppercase;
}
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon-truck"></i> UDC <i class="icon-chevron-right"></i> Captación</a>
...
<div id="cuadro_modulo_scouting_main" class="row-fluid" style="margin-top: 0px; color:black; font-family:Arial, Helvetica, sans-serif;"> 
        ...
        <table style="color:black; font-family: Arial, Helvetica, sans-serif; margin: 0px auto 10px;">
                <tbody>
                    <tr class="sin_fondo">
                        ...
                        <td>
                            <center>
                                <h3 class="titulo_principal" style="text-transform: uppercase;">UDC - CAPTACIÓN</h3>
                                <p style="margin: 0px;">
                                    En esta sección puedes crear, visualizar, modifcar y eliminar datos relacionados a la captación de jugadores
                                </p>
                            </center>
                        </td>
                    </tr>
    ...
    <div class="row-fluid cuadro_buscar_buscar" style="margin: 0px; padding:0px;">
        ...
        <div class="row-fluid" style="margin-top: 20px; /*margin-left: 5%;*/ width: 100%;">
            ...
            <div style="margin-left: 5%; width: 90%; margin: auto;">
                
                <!-- ========================================== Inicio del id="cuadro_captacion_main" ========================================== -->
                <div id="cuadro_captacion_main" style="text-align: center;margin: 0px;width: 30%;padding: 10px; float: left;">
                    ...
                    <div class="cuadro_serie" style="padding: 15px;" onclick="ir_scouting_jugadores();">
                        <div style="clear: right">
                            <div class="div-cuadro-principal">
                                <img src="../config/logo_equipo.png" style="height: 120px;">
                            </div>
                        </div>
                        <div class="nombre_seleccion"><h4 class="nombre-pais-inicio">CAPTACIÓN</h4></div>
                    </div>
                </div>
                <!-- ========================================== Fin del id="cuadro_captacion_main" ========================================== -->

                <!-- ========================================== Inicio del id="cuadro_enobservacion_main" ========================================== -->
                <div id="cuadro_enobservacion_main" style="text-align: center;margin: 0px;padding: 10px;width: 30%; float: left;">
                    <div class="serie-cantidad-jugadores">
                    ...
                    <div class="cuadro_serie" style="padding: 15px;" onclick="ir_scouting_entrenadores();">
                        ...
                        <div class="nombre_seleccion"><h4 class="nombre-pais-inicio">EN OBSERVACIÓN</h4></div>
                    </div>
                </div> 
                <!-- ========================================== Fin del id="cuadro_enobservacion_main" ========================================== -->

                <!-- ========================================== Inicio del id="cuadro_planificacion_main" ========================================== -->
                <div id="cuadro_planificacion_main" style="text-align: center;margin: 0px;padding: 10px;width: 30%; float: left;">
                    <div class="serie-cantidad-jugadores">
                        <i class="icon-male"></i> <span class="cantidad-entrenadores-scouting" style="font-weight: bold;">(0)</span>
                    </div>
                    <div class="cuadro_serie" style="padding: 15px;" onclick="ir_scouting_entrenadores();">
                        ...
                        <div class="nombre_seleccion"><h4 class="nombre-pais-inicio">PLANIFICACIÓN</h4></div>
                    </div>
                </div>
                <!-- ========================================== Fin del id="cuadro_planificacion_main" ========================================== -->
...
<div style="display: none; margin: -41px -22px 0px -20px; /*margin: -41px -30px 0px -20px;*/" id="cuadro_jugadores_seguimiento">
    ...
    <div class="cuadro_buscar_titulo" style="background-image: url('../config/banner_centro_scouting_1.png'); background-size: cover; height: 220px; margin-top: -10px">
        ...
        <div class="row-fluid">
            <div style="position: relative; left: 30px; top: 20px;">
                ...
                <div>
                    <div>
                        <div style="position: relative; width: 33px; top: 50px; left: 55px; height: 55px; background-color: #04136f; transform: skew(170deg);"></div>        
                    </div>
                    <div>
                        <h5 style="margin-top: 0px; color: white; padding: 15px 0px 0px 115px; font-size: 25px; text-transform: uppercase;">captación</h5>
                    </div>
                </div>
    ...
    <div class="row-fluid cuadro_buscar_buscar" style="width: 97%; margin: auto; margin-top: 20px;">
                ...
                <tbody>
                    <tr class="sin_fondo">
                        <td style="padding: 15px; text-align: center;">
                            <img src="../config/logo_equipo.png" style="/*height: 90px;*/ height: 110px;">
                        </td>

                        <td style="text-align: center;">
                            <p class="titulo_principal" style="margin: 0px; font-weight: bold; font-size: 18px; color: black;">ÁREA CAPTACIÓN</p>
                            <div class="titulo_cuadro_selected">
                                <p class="titulo_serie" style="margin-top: 10px; font-weight: bold; font-size: 14px; color: black; margin: 0; margin-top: 2px;">CAPTADOS</p>
                            </div>
                        </td>
                    </tr>
                </tbody>
        ...
        <button class="boton_volver" onclick="boton_volver_cuadro_scouting();" style="position: relative; top: -100px; float: left;">
            <i class="icon-arrow-left"></i> volver
        </button>   

        <div style="width:100%; background-color: <?php echo $color_fondo; ?> height:20px; border-radius: 4px; margin-bottom: 20px;"></div> 
        ...
        <div style="margin-top: 10px; margin-bottom: 60px;">
            ...
            <div style="margin-top: 20px;">
                ...
                <!-- ======================================================================== -->       
                <div class="span3" style="display: flex;">
                    <a class="btn btn-md btn-primary gray-a" style="width: 160px;"> 
                        Comuna procedencia
                    </a>
                    <select class="gray-input select-lateralidad-filtro-busqueda" id="lateralidad_fbjscouting_main" name="lateralidad_fbjscouting_main" onchange="buscar_jugadores_seguimiento( 2 );"></select>
                </div>
                    ...
                    <thead>
                        <tr style="background-color:#555555; color:white; font-size: 10px;">
                            ...
                            <th scope="col" style="cursor:pointer;padding:0px;width: 110px;">
                                <div class="tip-top" data-original-title="Posición" style="width: 85px;">posición</div>
                            </th>                            
                            <th scope="col" style="cursor:pointer; padding:0px; max-width: 100px; width: 100px; text-align: left;">
                                <div class="tip-top" data-original-title="Serie a la que ingresa" style="width: 100px;">serie a la que ingresa</div>
                            </th>                            
                            ...
                            <th scope="col" style="cursor:pointer; padding:0px;text-align: center;">
                                <div class="tip-top" data-original-title="RUT" style="width: 70px;">rut</div>
                            </th>
                            <th scope="col" style="cursor:pointer; padding:0px;text-align: center;">
                                <div class="tip-top" data-original-title="Fecha de Nacimiento" style="width:65px;">f. nacimiento</div>
                            </th>           
                            <th scope="col" style="cursor:pointer; padding:0px;text-align: center;">
                                <div class="tip-top" data-original-title="Año de Ingreso" style="width: 70px;">Año de Ingreso</div>
                            </th>                                       
                            <th scope="col" style="cursor:pointer; padding:0px;text-align: center;">
                                <div class="tip-top" data-original-title="Captador" style="width: 55px;">Captador</div>
                            </th>                                       
                            <th scope="col" style="cursor:pointer; padding:0px;text-align: left;">
                                <div class="tip-top" data-original-title="Vía de ingreso" style="width: 80px;">Vía ingreso</div>
                            </th>                                                        
                            <th scope="col" style="cursor:pointer; padding:0px;text-align: left;">
                                <div class="tip-top" data-original-title="Nacionalidad" style="width: 70px;">Nacionalidad</div>
                            </th>  
                            <th scope="col" style="cursor:pointer; padding:0px;text-align: left;">
                                <div class="tip-top" data-original-title="Categoría año" style="width: 90px;">Categoría año</div>
                            </th>                   
        ...
        <div class="row-fluid" style="margin-top: 30px;">
            ...
            <div class="span6">
                <figure class="highcharts-figure">
                    <div id="chart-jugadores-captados-por-categoria"></div>
            ...
            <div class="span6">
                <figure class="highcharts-figure">
                    <div id="chart-jugadores-captados-por-posicion"></div>
                    <p class="highcharts-description">
        ...
        <div class="row-fluid" style="margin-top: 30px;">
            ...
            <div class="span12">
                <figure class="highcharts-figure">
                    <div id="chart-comuna-procedencia"></div>
                    <p class="highcharts-description">
        ...
        <div class="row-fluid" style="margin-top: 30px;">
            ...
            <div class="span12">
                <figure class="highcharts-figure">
                    <div id="chart-nacionalidad-jugadores-captados"></div>
                    <p class="highcharts-description">
        ...
        <div class="row-fluid" style="margin-top:0px;">
            ...
            <div class="span12" style="margin-top: -10px; margin-left: 0;">
                    ...
                    <div style="width: 100%" class="datos_form_entrenador">
                      ...
                      <!-- ========================================== Inicio de campos a la derecha ========================================== -->
                      <div class="span8" style="margin: 0px; position: relative; left: 30px;">
                        <div class="span12"  style="margin: 0px;">
...
<!-- ========================== Inicio del id="modal_agregar_jugador" ========================== -->
<div id="modal_agregar_jugador" class="modal hide">
    ...
    <table style="color: black; font-family: Arial, Helvetica, sans-serif; margin: 0px auto 10px;">
        <tbody>
            <tr class="sin_fondo">
                <td style="text-align: center;">
                    <img src="../config/logo_equipo.png" style="height: 45px;position: relative;">
                </td>
                <td style="text-align: center;padding-left: 3px;">
                    <p class="titulo_principal" style="color: #021965; margin: 0px;line-height: 26px;font-weight: bold;font-size: 28px;text-transform: uppercase;letter-spacing: 0px;font-stretch: condensed;transform: scaleY(1.3); word-spacing: 4px;">
                        <span style="font-weight: normal; text-shadow: 0.5px 0px #232020; letter-spacing: 1px;">club</span>
                        <span style="text-shadow: 1px 0px #232020;letter-spacing: 1px;"> universidad de chile</span>
                    </p>
                    <p class="titulo_serie" style="color: #021965; margin-top: 10px;font-weight: normal;margin: 0;position: relative;top: 2px;font-size: 10px;text-transform: uppercase;letter-spacing: 15px; left: 8px;transform: scaleY(0.8);">
                        <span>más que una </span><span style="text-shadow: 0.5px 0px #232020;">pasión</span>                        
                    </p>
                </td>
            </tr>
        </tbody>
        ...
        <div>
            <center>
                <img src="../config/logo_equipo.png" style="width:35px;">
            </center>
    ...
    <div class="modal-body" style="padding: 0px;">
        ...
        <form method="post" ng-model="formulario_ficha_jugador" name="formulario_ficha_jugador" id="formulario_ficha_jugador" novalidate autocomplete="off" enctype="multipart/form-data">
            ...
            <!-- ========================================== Inicio del id="campos_ficha_jugador" ========================================== -->
            <div id="campos_ficha_jugador" class="span12">

                <div class="datos_fichaJugador" style="margin: 0px; margin-top: 10px width: 100%;">            
                    <p style="color: black; font-weight: bold; text-transform: uppercase; text-align: center; font-size: 14px;">registrar jugador captado</p>
                </div>

                <div style="width:90%; margin: auto; background-color: <?php echo $color_fondo; ?> height:20px; border-radius: 4px;"></div>                

                <div class="datos_fichaJugador" style="margin: 0px; margin-top: 15px; width: 100%;">            
                    <p style="color: black; font-weight: bold; text-transform: uppercase; text-align: center; font-size: 11px;">datos personales</p>
                </div>
                ...
                <div style="width: 100%;" class="datos_fichaJugador">
                    ...
                    <div class="span4">
                        ...
                        -->
                      <center>
                        <div id="image_preview_jugador" style="border: 6px solid <?php echo $color_fondo; ?> width: 140px;height: 140px;border-radius:100px;">
                            <img id="foto-jugador" src="../config/silueta_jugador.png" style="width: 100px;border-radius:100px;height: 140px;" class="img-thumbnail">
                        </div>
                        <label for="foto_jugador" class="boton_gestionar_cargos subiendo_foto" style="width:130px; margin-top:10px; font-size: 11px; border: 2px solid <?php echo $color_fondo; ?> text-shadow: 0.5px 0px <?php echo $color_fondo; ?>">
                            <i class="icon-cloud-upload"></i> Subir foto (.jpg o .png)
                        </label>
                        <input type="file" name="foto_jugador" id="foto_jugador" value="Seleccionar foto" style="display: none; background-color: white;">
                        <input type="hidden" name="foto_anterior_jugador" id="foto_anterior_jugador" value="" autocomplete="off" style="background-color: white;">
                  ...
                  <div class="span8" style="margin: 0px; position: relative; left: 30px;">
                    <div class="span12" style="margin: 0px;">
                        <div class="span6" style="margin: 0px; margin-bottom:20px;">
                          <div style="padding:0px; margin:0px;">
                            <a class="btn btn-md btn-primary green-a" style="border-bottom-left-radius:2px; border-top-left-radius:2px; margin-left: 0px; margin-right: 0px; width: 90px; margin-top:0px; background-color:<?php echo $color_fondo; ?>; font-size: 12px; margin-bottom:0px;"> Nombre</a><input type="text" class="my-input" maxlength="149" name="nombre" id="nombre" onkeyup="chequear_datos_form_fichajugador();" onkeydown="chequear_datos_form_fichajugador();" style="background-color: white;">
                            </div>
                        </div>
                        <div class="span6" style="margin: 0px; margin-bottom:20px;">
                          <div style="padding:0px; margin:0px;">
                            <a class="btn btn-md btn-primary green-a"> Apellido 1</a><input id="apellido1" name="apellido1" type="text" class="my-input" maxlength="149" onkeyup="chequear_datos_form_fichajugador();" onkeydown="chequear_datos_form_fichajugador();" style="background-color: white;"></div>
                          </div>
                    </div>
                    <!-- ==================================================================================== -->
                    <div class="span12" style="margin: 0px;">
                        <div class="span6" style="margin: 0px;">
                            <div style="padding:0px; margin:0px;">
                                <a class="btn btn-md btn-primary green-a"> Apellido 2</a><input id="apellido2" name="apellido2" type="text" class="my-input" maxlength="149" onkeyup="chequear_datos_form_fichajugador();" onkeydown="chequear_datos_form_fichajugador();" style="background-color: white;">
                            </div>
                        </div>
                        <div class="span6" style="margin: 0px; margin-bottom:20px;">
                            <a class="btn btn-md btn-primary green-a"> RUT</a><input class="my-input" id="rut" name="rut" type="text" placeholder="" style="background-color: white;" onkeyup="chequear_datos_form_fichajugador();" onkeydown="chequear_datos_form_fichajugador();">
                        </div>                        
                    </div>
                    <!-- ==================================================================================== -->
                    <div class="span12" style="margin: 0px;">
                        <div class="span6" style="margin: 0px; margin-bottom:20px;">
                            <a class="btn btn-md btn-primary green-a"> Fecha Nac</a><input class="date-picker my-input" id="fechaNacimiento" name="fechaNacimiento" size="16" type="text" readonly="" placeholder="Click aquí" style="background-color: white;">
                        </div>
                        <div class="span6" style="margin: 0px; margin-bottom:20px;">
                            <div style="padding:0px; margin:0px;">
                                <a class="btn btn-md btn-primary green-a"> Nacionalidad</a><select id="nacionalidad1" name="nacionalidad1" class="green-input select-pais-form" onchange="chequear_datos_form_fichajugador();" style="background-color: white;"></select>
                            </div>
                        </div>                  
                    </div>
                    <!-- ==================================================================================== -->
                    <div class="span12" style="margin: 0px;">
                        <div class="span6" style="margin: 0px; margin-bottom:20px;">
                            <div style="padding:0px; margin:0px;">
                                <a class="btn btn-md btn-primary green-a" style="font-size: 10px;"><div><p class="ellipsis-text" style="font-weight: normal;">Región procedencia</p></div></a><select class="green-input" id="region_procedencia" name="region_procedencia" onchange="chequear_datos_form_partidojugador();"></select>
                            </div>
                        </div>
                        <div class="span6" style="margin: 0px; margin-bottom:20px;">
                            <div style="padding:0px; margin:0px;">
                                <a class="btn btn-md btn-primary green-a" style="font-size: 10px;"><div><p class="ellipsis-text" style="font-weight: normal;">Comuna procedencia</p></div></a><select class="green-input" id="comuna_procedencia" name="comuna_procedencia" onchange="chequear_datos_form_partidojugador();"></select>
                            </div>
                        </div>
                    </div>
                    <!-- ==================================================================================== -->
                    ...
                    <div class="span12" style="margin: 0px;">
                        <div class="span6" style="margin: 0px; margin-bottom:20px;">
                            <div style="padding:0px; margin:0px;">
                                <a class="btn btn-md btn-primary green-a"> Formado en</a><input id="formado_en" name="formado_en" type="text" class="my-input" maxlength="149" onkeyup="chequear_datos_form_fichajugador();" onkeydown="chequear_datos_form_fichajugador();" style="background-color: white;">
                            </div>
                        </div>
                        <div class="span6" style="margin: 0px; margin-bottom:20px;">
                            <div style="padding:0px; margin:0px;">
                    ...
                    <!-- ========================================== Inicio de los datos de ingreso ==========================================  -->
                    <div id="datos_ingreso" style="position: relative; left: 30px;">
                        <div class="span12" style="margin: 0px;">
                            <div class="span12" style="margin: 0px; ">
                                <div style="padding:0px; margin:0px;">
                                    <p style="color: black; font-weight: bold; text-transform: uppercase; text-align: center;">datos de ingreso</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="span12" style="margin: 0px; margin-top: 10px;">
                            <div class="span4" style="margin: 0px; margin-bottom:20px;">
                                <div style="padding:0px; margin:0px;">
                                    <a class="btn btn-md btn-primary green-a"> Fecha Ingreso</a><input class="date-picker my-input" id="fechaIngreso" name="fechaIngreso" size="16" type="text" readonly="" placeholder="Click aquí" style="background-color: white;">
                                </div>
                            </div>
                            
                            <div class="span4" style="margin: 0px; margin-bottom:20px;">
                                <div style="padding:0px; margin:0px;">
                                    <a class="btn btn-md btn-primary green-a" style="font-size: 10px;"><div><p class="ellipsis-text" style="font-weight: normal;">Categoría de ingreso</p></div></a><select id="categoria_ingreso" name="categoria_ingreso" class="select-posicion-jugador-form select-posicion-jugador-form-adicional green-input " style="width:52.5%;" onchange="chequear_datos_form_fichajugador();">
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="span4" style="margin: 0px; margin-bottom:20px; margin-left: 5px;">
                                <div style="padding:0px; margin:0px;">
                                    <a class="btn btn-md btn-primary green-a" style="font-size: 10px;"><div><p class="ellipsis-text" style="font-weight: normal;">Vía de ingreso</p></div></a><select id="via_ingreso" name="via_ingreso" class="select-posicion-jugador-form select-posicion-jugador-form-adicional green-input " style="width:52.5%;" onchange="chequear_datos_form_fichajugador();">
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="span12" style="margin: 0px; margin-top: 10px;">
                            <div class="span4" style="margin: 0px; margin-bottom:20px;">
                                <div style="padding:0px; margin:0px;">
                                    <a class="btn btn-md btn-primary green-a" style="font-size: 10px;"><div><p class="ellipsis-text" style="font-weight: normal;">Seleccionado</p></div></a><select id="idclub_procedencia" name="idclub_procedencia" class="green-input select-club" onchange="chequear_datos_form_fichajugador();" style="background-color: white;"></select>
                                </div>
                            </div>
                            <div class="span4" style="margin: 0px; margin-bottom:20px;">
                                <div style="padding:0px; margin:0px;">
                                    <a class="btn btn-md btn-primary green-a"> Captador</a><input class="my-input" id="captador" name="captador" type="text" placeholder="" style="background-color: white;" onkeyup="chequear_datos_form_fichajugador();" onkeydown="chequear_datos_form_fichajugador();">
                                </div>
                            </div>                        
                        </div>
                        ...
                        <div class="span12" style="margin: 0px; margin-top: 10px;">
                            <table style="width: 95.2%; margin-bottom: 15px;">
                                <thead>
                                    <tr>
                                        <th class="th-textarea">Características que lo hicieron quedar en el club</th>
                                    </tr> 
                                </thead>
                                <tbody>
                                    <tr>
                                        <td style="width: 100%; padding: 0px;">
                                            <div class="span12" style="display: flex; width: 100%;">
                                                <textarea onkeyup="chequear_datos_form_fichajugador();" style="resize: none; background-color: white;" class="textarea-social" name="caracteristicas_estadia_club" id="caracteristicas_estadia_club" rows="10"></textarea>
                                            </div>
                                        </td>                                                  
                                    </tr>
                                </tbody>
                        ...
                        <div class="span12" style="margin: 0px; margin-top: 10px;">
                            <table style="width: 95.2%; margin-bottom: 15px;">
                                <thead>
                                    <tr>
                                        <th class="th-textarea">Aspectos a mejorar</th>
                                    </tr> 
                                </thead>
                                <tbody>
                                    <tr>
                                        <td style="width: 100%; padding: 0px;">
                                            <div class="span12" style="display: flex; width: 100%;">
                                                <textarea onkeyup="chequear_datos_form_fichajugador();" style="resize: none; background-color: white;" class="textarea-social" name="aspectos_mejorar" id="aspectos_mejorar" rows="10"></textarea>
                                            </div>
                                        </td>                                                  
                                    </tr>
                                </tbody>
                    ...
                    <!-- ========================================== Fin de los datos de ingreso ==========================================  --> 

                    <!-- ========================================== Inicio de los datos de contacto ==========================================  -->
                    <div id="datos_contacto" style="position: relative; left: 30px;">
                        <div class="span12" style="margin: 0px;">
                            <div class="span12" style="margin: 0px; ">
                                <div style="padding:0px; margin:0px;">
                                    <p style="color: black; font-weight: bold; text-transform: uppercase; text-align: center; font-size: 11px;">datos de contacto</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="span12" style="margin: 0px; margin-top: 10px;">
                            <div class="span4" style="margin: 0px; margin-bottom:20px;">
                                <div style="padding:0px; margin:0px;">
                                    <a class="btn btn-md btn-primary green-a"> Teléfono</a><input class="date-picker my-input" id="telefono_contacto" name="telefono_contacto" size="16" type="text" style="background-color: white;">
                                </div>
                            </div>
                            
                            <div class="span4" style="margin: 0px; margin-bottom:20px;">
                                <div style="padding:0px; margin:0px;">
                                    <a class="btn btn-md btn-primary green-a"> Email</a><input class="date-picker my-input" id="email" name="email" size="16" type="text" style="background-color: white;">
                                </div>
                            </div>

                            <div class="span4" style="margin: 0px; margin-bottom:20px; margin-left: 5px;">
                                <div style="padding:0px; margin:0px;">
                                    <a class="btn btn-md btn-primary green-a"> Apoderado</a><input class="date-picker my-input" id="apoderado" name="apoderado" size="16" type="text" style="background-color: white;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="span12" style="margin: 0px; margin-top: 10px;">
                            <div class="span4" style="margin: 0px; margin-bottom:20px;">
                                <div style="padding:0px; margin:0px;">
                                    <a class="btn btn-md btn-primary green-a" style="font-size: 10px;"><div><p class="ellipsis-text" style="font-weight: normal;">Teléfono Apoderado</p></div></a><input class="date-picker my-input" id="telefono_apoderado" name="telefono_apoderado" size="16" type="text" style="background-color: white;">  
                                </div>
                            </div>
                            <div class="span4" style="margin: 0px; margin-bottom:20px;">
                                <div style="padding:0px; margin:0px;">
                                    <a class="btn btn-md btn-primary green-a" style="font-size: 10px;"><div><p class="ellipsis-text" style="font-weight: normal;">Email Apoderado</p></div></a><input class="date-picker my-input" id="email_apoderado" name="email_apoderado" size="16" type="text" style="background-color: white;">
                                </div>
                            </div>                        
                        </div>                        
                    </div>
                    <!-- ========================================== Fin de los datos de contacto ==========================================  -->

                </div>
            </div>            
            <!-- ========================================== Fin del id="campos_ficha_jugador" ========================================== -->
...
<!-- ========================== Fin del id="modal_agregar_jugador" ========================== -->
...
function btn_ir_form_agregarjugador() {
    ...
    $('#modal_agregar_jugador').modal('show');
...
// -------------------------------------------- Inicio del gráfico de jugadores captados por categoría -------------------------------------------- //
var chart_jugadores_captados_por_categoria = Highcharts.chart('chart-jugadores-captados-por-categoria', {
    chart: {
    ...
    title: {
        text: 'Jugadores captados por categoría'
    },
   tooltip: {
      headerFormat: '<span style="font-size:11px">{series.name}</span><br>',
        pointFormat: '<span style="color:{series.color}">{point.name}</span>: <b>{point.y} captados </b> ({point.percentage:.0f}%)<br/>',
        shared: true
    },
    accessibility: {
        point: {
    ...
    plotOptions: {
        pie: {
            ...
            dataLabels: {
                enabled: true,
                format: '<b>{point.name}</b>: {point.y:.0f} Jugadores ({point.percentage:.1f} %)'
            }
        }
    },
    series: [{
...
// -------------------------------------------- Fin del gráfico de jugadores captados por categoría -------------------------------------------- //

// -------------------------------------------- Inicio del gráfico de jugadores captados por posición -------------------------------------------- //
var chart_jugadores_captados_por_posicion = Highcharts.chart('chart-jugadores-captados-por-posicion', {
    chart: {
        type: 'bar',
        backgroundColor:null
    },
    title: {
        text: 'Jugadores captados por posicion'
    },
    subtitle: {
        text:null
    },
    ...
    tooltip: {
        pointFormat: 'Captados: <b>{point.y:.0f} Jugadores</b>'
    },
    series: [{
        name: 'Posicion',
        colorByPoint:true,
        data: [
            ['Arquero', 24.2],
            ['Defensa central', 20.8],
            ['Lateral', 14.9],
            ['Extremo', 13.7],
            ['Volante Ofensivo', 13.1],
            ['Volante Defensivo', 12.7],
            ['Volante Mixto', 12.4],
            ['Volante izquierdo', 12.2],
            ['Volante derecho', 12.0],
...
// -------------------------------------------- Fin del gráfico de jugadores captados por posición -------------------------------------------- //

// -------------------------------------------- Inicio del gráfico de comuna de procedencia -------------------------------------------- //
// Build the chart
var chart_comuna_procedencia = Highcharts.chart('chart-comuna-procedencia', {
    chart: {
        plotBackgroundColor: null,
        plotBorderWidth: null,
        plotShadow: false,
...
// -------------------------------------------- Fin del gráfico de comuna de procedencia -------------------------------------------- //

// -------------------------------------------- Inicio del gráfico de la nacionalidad de jugadores captados -------------------------------------------- //
var chart_nacionalidad_jugadores_captados = Highcharts.chart('chart-nacionalidad-jugadores-captados', {
    chart: {
        type: 'variablepie',
        backgroundColor:null
    },
    title: {
        text: 'Nacionalidad de los jugadores captados'
    },
    tooltip: {
        headerFormat: '',
        pointFormat: '<span style="color:{point.color}">\u25CF</span> <b> {point.name}</b><br/>' +
            'Jugadores captados: <b>{point.y}</b><br/>' 
...
// -------------------------------------------- Fin del gráfico de la nacionalidad de jugadores captados -------------------------------------------- //

window.setTimeout(function(){
    $(window).trigger('resize');
    chart_jugadores_captados_por_categoria.reflow();
    chart_jugadores_captados_por_posicion.reflow();
    chart_comuna_procedencia.reflow();
    chart_nacionalidad_jugadores_captados.reflow(); 
}, 500);
