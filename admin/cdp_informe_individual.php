<?php
    ...
    if(!(isset($_SESSION["nombre_usuario_software"]))){
        ...
        $menu_actual="cdp";
        $submenu_actual="cdp_informe_individual";
        $seccion_comentarios = $comentarios['cdp_informe_individual'];//mis cuotas
        $demo_seccion = $demo['cdp_informe_individual'];
        $nombre_pestana_navegador='Informe Individual';
...
<title><?php echo $nombre_pestana_navegador;?> | Informe Individual</title>
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon-truck"></i> CDP <i class="icon-chevron-right"></i> Informe Individual</a>
...
<table style="color: black; font-family: Arial, Helvetica, sans-serif; margin: 0px auto 10px;">
      ...
      <input class="tecnico" type="hidden">  
                                ...
                                <td style="text-align: center;">
                                    <h3 class="titulo_principal" style="margin: 0px; line-height: 26px;">INFORME INDIVIDUAL</h3>
                ...
                <table style="border: 0px solid #8f8f8f; width:100%;" id="tabla_ver_perfil_jugador">
                    <thead>
                        <tr style="background-color:#555555; color:white;">
                            ...
                            <th scope="col" style="cursor:pointer; padding:0px; max-width: 150px; width: 150px;">
                                <div class="tip-top" data-original-title="Fecha del Informe" style="text-align: center;">FECHA INFORME</div>
                            </th>                                                
                            <th scope="col" style="cursor:pointer; padding:0px; max-width: 120px; width: 120px;">
                                <div class="tip-top" data-original-title="Serie" style="width:100%; text-align: center;">SERIE</div>
                            </th>
                            <th scope="col" style="cursor:pointer; padding:0px; max-width: 120px; width: 120px;">
                                <div class="tip-top" data-original-title="Año de la Serie" style="width:100%; text-align: center;">AÑO SERIE</div>
                            </th>  
                            <th scope="col" style="cursor:pointer; padding:0px; max-width: 120px; width: 120px;">
                                <div class="tip-top" data-original-title="Temporada" style="width:100%; text-align: center;">TEMPORADA</div>
                            </th>  
                            <th scope="col" style="cursor:pointer; padding:0px; max-width: 120px; width: 120px;">
                                <div class="tip-top" data-original-title="Título" style="width:100%; text-align: center;">TÍTULO</div>
                            </th>                                                                                    
                        ...
                        <tbody>
                                ...
                                <td style="width: 100%; padding: 0px;">
                                    <div style="width:650px;">
                                        <div class="span3" style="width: 45%; display: flex;">
                                            <a class="btn btn-md btn-primary" style="width: 80px; border-bottom-left-radius:2px; border-top-left-radius:2px; font-size: 13px; background-color:<?php echo $color_fondo; ?> height: 22px;"> <span style="margin-right: 20px;">Fecha</span>
                                            </a>
                                            <input readonly class="date_fechaNacimiento" type="text" onchange="chequear_datos();" style="width:150px; -webkit-appearance: none; -moz-appearance : none; border: 2px solid <?php echo $color_fondo; ?> border-bottom-right-radius:2px; border-top-right-radius:2px; border-bottom-left-radius:0px; border-top-left-radius:0px; margin-bottom:0px; text-align:center; line-height: 16px;" name="fecha_cdp_informeindiv" id="fecha_cdp_informeindiv" />                                           
                                        </div>
                                        <div class="span3" style="width: 45%; display: flex;">
                                            <a class="btn btn-md btn-primary" style="width: 250px; border-bottom-left-radius:2px; border-top-left-radius:2px; font-size: 13px; background-color:<?php echo $color_fondo; ?> height: 22px;"> <span style="margin-right: 20px;">Título</span>
                                            </a>
                                            <input type="text" onkeyup="chequear_datos();" style="width:300px; -webkit-appearance: none; -moz-appearance : none; border: 2px solid <?php echo $color_fondo; ?> border-bottom-right-radius:2px; border-top-right-radius:2px; border-bottom-left-radius:0px; border-top-left-radius:0px; margin-bottom:0px; text-align:center; line-height: 16px;" name="titulo_cdp_informeindiv" id="titulo_cdp_informeindiv" />                                          
                                        </div>                                         
                                    </div>                                   
                                </td>                               
                            </tr>  
                            ...
                            <tr class="sin_fondo">
                                <table style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="th-textarea">INFORME INDIVIDUAL</th>
                                        </tr> 
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td style="width: 100%; padding: 0px;">
                                                <div class="span12" style="display: flex; width: 100%;">
                                                    <textarea onkeyup="chequear_datos();" style="resize: none;" class="textarea-social" name="informe_cdp_informeindiv" id="informe_cdp_informeindiv" rows="25"></textarea>
                                                </div>
                                            </td>                                                  
                                        </tr>
                                    </tbody>
...
<script>
    ...
    */
    ...
    function get_cantidad_jugadores_sexo_serie(){
        ...
        $.ajax({
            url: "post/cdp_ver_informe_individual.php",
            type: "post",
            dataType: 'json',
            cache: false,
            data: {
        ...
        $.ajax({
            ...
            success: function(respuesta){
                ...
                if(respuesta== ""){ //jugador sin informes
                    ...
                    window.datos_informe_individual = respuesta; //se copian todos los profesores al cache
                    $("#tabla_ver_perfil_jugador tbody").empty();
                    var count = 1;

                    for(var i=0; i < respuesta.length; i++){              

                        let fecha_cdp_informeindiv = respuesta[i]['fecha_cdp_informeindiv'];
                        
                        // Día:
                        let dia_talento = fecha_cdp_informeindiv.substring(8, 10); 

                        // Mes:
                        let mes_talento = fecha_cdp_informeindiv.substring(5, 7);     

                        // Año:
                        let anio_talento = fecha_cdp_informeindiv.substring(0, 4); 

                        fecha_cdp_informeindiv = dia_talento + "-" + mes_talento + "-" + anio_talento;
                        ...
                        '<tr class="panel_buscar" style="height:27px;cursor:pointer; color:#555555; font-size:13px;">\
                            ...
                            <td class="td-valoracion" onclick="boton_editar('+i+')" style="text-align: center; max-width: 298px; width: 298px;">\
                                <p class="ellipsis-text">\
                                    '+fecha_cdp_informeindiv+'\
                                </p>\
                            </td>\
                            <td onclick="boton_editar('+i+')" class="td-valoracion" style="text-align: center; font-weight: bold; text-transform: capitalize; max-width: 87px; width: 87px;">\
                                <p class="ellipsis-text">\
                                    '+titulo_serie_tabla+'\
                                </p>\
                            </td>\
                            <td onclick="boton_editar('+i+')" class="td-valoracion" style="text-align: center; font-weight: bold; max-width: 77px; width: 77px;">\
                                <p class="ellipsis-text"></p>\
                            </td>\
                            <td onclick="boton_editar('+i+')" class="td-valoracion" style="text-align: center; font-weight: bold; max-width: 120px; width: 120px;">\
                                <p class="ellipsis-text"></p>\
                            </td>\
                            <td onclick="boton_editar('+i+')" class="td-valoracion" style="text-align: center; font-weight: bold; max-width: 120px; width: 120px;">\
                                <p class="ellipsis-text">\
                                    '+respuesta[i]['titulo_cdp_informeindiv']+'\
                                </p>\
                            </td>\
                            <td style="padding: 7px; width: 9px;">\
                                <a class="boton_eliminar" onclick="descargarPDF('+respuesta[i]['idcdp_informe_individual']+', '+titulo_serie_reporte+', '+sexo_seleccion_reporte+');">\
...
function boton_ver_perfil_jugador( linea ){
    ...
    window.idcdp_informe_individual ='';

    // alert( idfichaJugador + ' - ' + nombre_completo_jugador + ' - ' + edad + ' - ' + numero_posicion );
    $(".idfichaJugador").val( datos_informe_individual[linea]['idfichaJugador'] );
    $(".nombre-jugador").html( datos_informe_individual[linea]['nombre'] + " " + datos_informe_individual[linea]['apellido1'] + " " + datos_informe_individual[linea]['apellido2'] );    

    // Posición:
    let posicion;
    // Validando datos (nulos, vacíos, '0', '0000-00-00', ect):
    if( datos_informe_individual[linea]['posicion0'] === null || datos_informe_individual[linea]['posicion0'] == '0' || datos_informe_individual[linea]['posicion0'] == '' || datos_informe_individual[linea]['posicion0'] == '999' ) {
        posicion = 'Posición no especificada';
    } else {
        posicion = parseInt( datos_informe_individual[linea]['posicion0'] );
    ...
    let dinamico;
    // Validando datos (nulos, vacíos, '0', '0000-00-00', ect):
    if( datos_informe_individual[linea]['dinamico'] === null || datos_informe_individual[linea]['dinamico'] == '0' || datos_informe_individual[linea]['dinamico'] == '' ) {
        dinamico = 'Pie hábil no especificado';
    } else {
        dinamico = parseInt( datos_informe_individual[linea]['dinamico'] );
    ...
    let edad;
    // Validando datos (nulos, vacíos, '0', '0000-00-00', ect):
    if( datos_informe_individual[linea]['fechaNacimiento'] === null || datos_informe_individual[linea]['fechaNacimiento'] == '0000-00-00' || datos_informe_individual[linea]['fechaNacimiento'] == '' ) {
        edad = '0 años (no especificado), ';
    } else {
        edad = calcularEdad( datos_informe_individual[linea]['fechaNacimiento'] ) + ' Años, ';
    }
    ...
    $(".imagen-jugador").attr("src", "foto_jugadores/" + datos_informe_individual[linea]['idfichaJugador'] + '.png');
...
/*
    ...
    // alert( idfichaJugador + ' - ' + nombre_completo_jugador + ' - ' + edad + ' - ' + numero_posicion );
    if( datos_informe_individual[linea]['apellido2'] == null ) {
        datos_informe_individual[linea]['apellido2'] == "nada";
    } 
    $(".idfichaJugador").val( datos_informe_individual[linea]['idfichaJugador'] );
    $(".nombre-jugador").html( datos_informe_individual[linea]['nombre'] + " " + datos_informe_individual[linea]['apellido1'] + " " + datos_informe_individual[linea]['apellido2'] );    

    let posicion = parseInt( datos_informe_individual[linea]['numero_posicion'] );
    switch( posicion ) {
        case 1:
            posicion = "Arquero";
            break;
    ...
    let dinamico = parseInt( datos_informe_individual[linea]['dinamico'] );
    switch( dinamico ) {
        case 0:
            dinamico = "Derecho";
            break;
    ...
    let edad = calcularEdad( datos_informe_individual[linea]['fechaNacimiento'] );
...
function boton_agregar_informe_carga(){
    ...
    $("#fecha_cdp_informeindiv").val( fecha_actual );   
...
// -------------------------- Inicio de la función 'boton_editar( idcdp_informe_individual )' - EDITAR (UPDATE) --------------------------- //
function boton_editar( linea ){
    
    // alert( window.idcdp_informe_individual );
    window.idcdp_informe_individual = datos_informe_individual[linea]['idcdp_informe_individual'];
    $("#fecha_cdp_informeindiv").val( datos_informe_individual[linea]['fecha_cdp_informeindiv'] );
    $("#titulo_cdp_informeindiv").val( datos_informe_individual[linea]['titulo_cdp_informeindiv'] );
    $("#informe_cdp_informeindiv").val( datos_informe_individual[linea]['informe_cdp_informeindiv'] );

    // -------------------------------------------------------- //
    // alert( idfichaJugador + ' - ' + nombre_completo_jugador + ' - ' + edad + ' - ' + numero_posicion );
    
    if( datos_informe_individual[linea]['apellido2'] === null ) {
        datos_informe_individual[linea]['apellido2'] = "";
    } 
...
// -------------------------- Fin de la función 'boton_editar( idcdp_informe_individual )' - EDITAR (UPDATE) --------------------------- //

function boton_eliminar( linea ){
    window.idcdp_informe_individual= datos_informe_individual[linea]['idcdp_informe_individual'];
    // alert( idcdp_informe_individual );
    $('#myModal2').modal('show');
    $('#mensaje_eliminar_proveedor').html('<h5>¿Estás seguro que quieres eliminar este informe?</h5>*Al borrarlo se perderán todos los datos asociados!<br><img src="../config/remover_archivo.png">');
    $('.boton_modal').show();
}
...
function eliminar_informe() {
    ...
    //alert( window.idcdp_informe_individual );
     ...
     $.ajax({
        url: "post/cdp_eliminar_informe_individual.php",
        type: "post",
        data: {
            'idcdp_informe_individual': window.idcdp_informe_individual
        },success: function(respuesta) {
...
function boton_guardar(){
    // alert( window.idcdp_informe_individual );
    if (window.idcdp_informe_individual != "" ) {
...
function guardar_registro(){
    ...
    data.push({name: 'idcdp_informe_individual',  value: window.idcdp_informe_individual});
    ...
    $.ajax({
        url: "post/cdp_guardar_informe_individual.php",
        type: "post",
        data: data,
        dataType: 'json',
        cache: false,
            ...
            if(respuesta== ""){ //jugador sin informes
                ...
                for(var i=0; i < respuesta.length; i++){
                    ...
                    */
                    ...
                    // alert( respuesta[i]['idcdp_informe_individual'] );
                    if( typeof respuesta[i]['idcdp_informe_individual'] === 'undefined' ) {
...
function chequear_datos(){
    ...
    // ------------------------------------------------------------------------ //
    let fecha_cdp_informeindiv = $("#fecha_cdp_informeindiv").val();
    if( fecha_cdp_informeindiv == "" ) {
        $("#fecha_cdp_informeindiv").css("background-color", "white"); // <--- Color blanco.
        flag = false;
    } else {
        $("#fecha_cdp_informeindiv").css("background-color", "white");
    }

    // ------------------------------------------------------------------------ //
    let titulo_cdp_informeindiv = $("#titulo_cdp_informeindiv").val();
    if( titulo_cdp_informeindiv != "" ) {
        if( titulo_cdp_informeindiv.match(ER_caracteresAlfaNumericos) && ( parseInt(titulo_cdp_informeindiv.length) >= 1 && parseInt(titulo_cdp_informeindiv.length) <= 150 ) ) {      
            $("#titulo_cdp_informeindiv").css("background-color", "white");
        } else {
            $("#titulo_cdp_informeindiv").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#titulo_cdp_informeindiv").css("background-color", "#ffc6c6");
    ...
    // ------------------------------------------------------------------------ //
    let informe_cdp_informeindiv = $("#informe_cdp_informeindiv").val();
    if( informe_cdp_informeindiv != "" ) {
        if( informe_cdp_informeindiv.match(ER_caracteresAlfaNumericos) && ( parseInt(informe_cdp_informeindiv.length) >= 1 && parseInt(informe_cdp_informeindiv.length) <= 2000 ) ) {      
            $("#informe_cdp_informeindiv").css("background-color", "white");
        } else {
            $("#informe_cdp_informeindiv").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#informe_cdp_informeindiv").css("background-color", "#ffc6c6");
...
function descargarPDF( idcdp_informe_individual, titulo_serie_reporte, sexo_seleccion_reporte ){

console.log("ID Intervención Individual: " + idcdp_informe_individual );
