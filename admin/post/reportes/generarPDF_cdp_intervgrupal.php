...
$datos_informe = buscar_datosPDF( $_POST['idcdp_intervencion_grupal'] );
$titulo_serie = $_POST["titulo_serie"];
$nombre_tecnico = $_POST["nombre_tecnico"];
$jugador = '';


$fecha_cdp_intervgrupal = $datos_informe[0]['fecha_cdp_intervgrupal'];
$intervdinamica_cdp_intervgrupal = $datos_informe[0]['intervdinamica_cdp_intervgrupal'];
$materiales_cdp_intervgrupal = $datos_informe[0]['materiales_cdp_intervgrupal'];
$objetivos_cdp_intervgrupal = $datos_informe[0]['objetivos_cdp_intervgrupal'];
$actividadrealizar_cdp_intervgrupal = $datos_informe[0]['actividadrealizar_cdp_intervgrupal'];
      ...
      <div class="totalpaginas">
        <div class="txCenter" style="box-sizing: border-box;">
          ...
          <div style="/*background-color: green;*/ position: relative; left: 0px;">
            ...
            <br/><br/>
            <span style="/*background-color:orange;*/ font-size:20px; font-weight:bold;">INTERVENCIONES GRUPALES</span>                       
          </div>      
...
<main>
        ...
        <div class="totalpaginas">
          <table class="tabla-datos-principales-derecha">
            <tr>
              ...
              <td class="datos-principales">'.$fecha_cdp_intervgrupal.'</td>
            </tr>
          </table>   
    ...
    <center>
      <div class="txCenter wab" style="margin-top:10px;">
        <div class="totalpaginas">
          ...
          <div class="textarea-social txCenter">'.$intervdinamica_cdp_intervgrupal.'</div>
        </div>
      </div>
    </center> 
    ...
    <center>
      <div class="txCenter wab">
        <div class="totalpaginas">
          ...
          <div class="textarea-social">'.$materiales_cdp_intervgrupal.'</div>
        </div>
      </div>
    </center>       
    ...
    <center>
      <div class="txCenter wab">
        <div class="totalpaginas">
          ...
          <div class="textarea-social">'.$objetivos_cdp_intervgrupal.'</div>
        </div>
      </div>
    </center>       
    ...
    <center>
      <div class="txCenter wab">
        <div class="totalpaginas">
          ...
          <div class="textarea-social">'.$actividadrealizar_cdp_intervgrupal.'</div>
        </div>
      </div>
    </center>       
  ...
  <footer>
    ...
    <p style="text-align: center; font-weight: bold; margin-top: 10px;">
      CDP '.date("Y").' | Intervención Grupal ingresada el '.$fecha_software_date.' a las '.$fecha_software_time.'.
    <p>
  </footer>  
</main>
...
$titulo_documento_salida = "[11Analytics]_cdp_intervencion_grupal.pdf";
