...
$filas_jugadores_estudiando = '';

for ($i=0; $i < 3; $i++) {
    $filas_jugadores_estudiando .= '
    <tr>
        <td style="text-align: left;"> 
            <img src="../../../config/foto_jugador.png" style="width: 17px; height: 17px; border-radius: 9px; border: solid 1px #c1c1c1; background-color: white; margin-top: 3px;">
            <p style="display: inline-block; margin-left: 2px;">Juan Pablo García T</p>
        </td>
        <td style="text-align: left;">18.586.206-2</td>
        <td style="text-align: center;">2020</td>
        <td style="text-align: left;">Primer Semestre</td>
        <td style="text-align: center;">Estudiando</td>
        <td style="text-align: left;">Liceo Mixto nº2</td>
        <td style="text-align: left;">Puente Alto</td>
        <td style="text-align: left;">E. Media</td>
        <td style="text-align: center;">1º Medio</td>
        <td style="text-align: right;">15:00 – 18:00 hrs</td>
        <td style="text-align: center;">6.1</td>
        <td style="text-align: center;">J.Completa</td>
    </tr>
    ';
}
  ...
  <main>
    ...
    <div class="txCenter div-body" style="box-sizing: border-box; width: 95%; margin: auto; margin-top: 10px;">
        ...
        <div style="margin-top: 0px; max-width: 625px; margin: auto; width: 625px; /*background-color: orange;*/">
            ...
            <p  style="text-align: center; margin-top: 2px; margin-bottom: 25px; font-size: 14px; color: #4e4e4e;" class="big-text">REGISTRO EDUCACIONAL</p>
            
            <!-- VERSIÓN QUE FUNCIONA EN LOCAL -->
            <!--
            <img src="../../../config/logo_equipo.png" style="height: 100px;">
            -->

            <!-- VERSIÓN QUE FUNCIONA EN EL SERVIDOR -->
            <img src="../../../config/logo_equipo.png" style="height: 100px; margin-top: -17px; margin-bottom: 20px;">
                        

            <div style="border-top: 2px solid #3c3b3b; border-bottom: 2px solid #3c3b3b; width: 25%; margin: auto; margin-top: -18px;">
                <p style="background-color: transparent; text-transform: uppercase; font-family: Open Sans, sans-serif!important; font-size: 9px; margin-top: 3px; margin-bottom: 1px">SUB 17 MASCULINA</p>
            </div>  
        </div>
        ...
        <!-- ============================================================================================================ -->
        <center>
            <div style="background-color: transparent; margin-top: 35px; width: 100%;">
                <div class="left-div-title"></div>
                <div class="middle-div-title">
                    <p style="">JUGADORES ESTUDIANDO</p>
                </div>
        ...
        <table class="bottom-space-modal tabla-item tabla-datos">
            <thead>
                <tr>
                   <th style="text-align: left; width: 110px;">
                        <span style="display: block; position: relative; left: 18px;">JUGADOR</span>
                    </th>
            ...
            <tbody>'.$filas_jugadores_estudiando.'</tbody>                 
        </table>   
        ...
        <center>
            <div style="background-color: transparent; width: 100%;">
                <div class="left-div-title"></div>
                <div class="middle-div-title">
                    <p style="">JUGADORES ESTUDIOS FINALIZADOS</p>
                </div>
                <div class="right-div-title"></div>
            </div> 
        </center>
        ...
        <div style="width: 100%; /*background-color: orange;*/ clear: both; margin-bottom: 55px;">
            <p class="text-sin-registros">No se registran juguadores con estudios finalizados</p>
        </div>
        ...
        <center>
            <div style="background-color: transparent; width: 100%;">
                <div class="left-div-title"></div>
                <div class="middle-div-title">
                    <p style="">JUGADORES NO ESTUDIANDO</p>
                </div>
                <div class="right-div-title"></div>
            </div> 
        </center>
        ...
        <div style="width: 100%; /*background-color: orange;*/ clear: both; margin-bottom: 55px;">
            <p class="text-sin-registros">No se registran juguadores no estudiando</p>
        </div>
...
$titulo_documento_salida = "[11Analytics]_ffch_registro_educacional.pdf";
