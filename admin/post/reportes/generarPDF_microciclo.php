...
$data.= '
    <div class="fontFamily" style="position: relative; height: 40px;">
        <img src="../../img/logosw.png" style="position: absolute; height: 100px; left: 11px;">
        <img src="../../img/foto_jugador.png" style="border: 3px solid #D62A1C; border-radius: 51px 51px 51px 51px; width: 100px; position: absolute; right: 0px;">
    </div>

    <h2 class="txCenter" style="font-weight: bold; margin-bottom:-15px; font-family: helvetica; font-size: 23px; text-transform: uppercase;">'.$nombre_jugador.'</h2>
    <h2 class="tx16 txCenter" style="font-weight: bold; margin-bottom:30px; font-family: helvetica;">INFORME MICROCILIO JUGADOR</h2>
    
    <div style="margin-bottom:15px; background: #D62A1C; height: 20px; border-radius: 2px 2px 2px 2px;"></div>
    
    <p class="helvetica tx12" style="margin-bottom: 0px;">Fecha del informe: '.$fecha_informe.'</p>
    
    <h5 class="txCenter tx16 helvetica" style="font-weight: bold; margin-top: 0px; margin-bottom: 7px; padding:5px;">Datos del jugador</h5>
    <table class="helvetica" style="margin-bottom: 10px; width: 100%;">
        <tr class="tx12">
            <td style="width: 120px;"><b>Rut</b></td>
            <td style="width: 300px;">'.$dataJugador['rut'].'</td>
            
            <td style="width: 120px;"><b>Fecha Nac.</b></td>
            <td>'.substr($dataJugador['fecha_nacimiento'],8,2).'-'.substr($dataJugador['fecha_nacimiento'],5,2).'-'.substr($dataJugador['fecha_nacimiento'],0,4).'</td>
        </tr>
        <tr class="tx12">
            <td style="width: 120px;"><b>Nombre</b></td>
            <td style="width: 300px;">'.$dataJugador['nombre'].'</td>
            
            <td style="width: 120px;"><b>Edad</b></td>
            <td>'.$dataJugador['edad'].' años</td>
        </tr>
        <tr class="tx12">
            <td style="width: 120px;"><b>Primer Apellido</b></td>
            <td style="width: 300px;">'.$dataJugador['apellido1'].'</td>
            
            <td style="width: 120px;"><b>Sexo</b></td>
            <td>'.$sexo.'</td>
        </tr>
        <tr class="tx12">
            <td style="width: 120px;"><b>Segundo Apellido</b></td>
            <td style="width: 300px;">'.$dataJugador['apellido2'].'</td>
            
            <td style="width: 120px;"><b>Posición</b></td>
            <td>'.$dataJugador['posicion'].'</td>
        </tr>
    </table>
    
    <div class="tg tg-0pky tx14" style="height: 150px; font-family: helvetica; margin-bottom:10px; padding: 5px;">'.$descripcion.'</div>
    
    <h2 class="tx16 txCenter" style="font-weight: bold; margin-bottom:10px; font-family: helvetica; color: #ffffff; background: #D62A1C; padding: 7px;">DETALLE INFORME</h2>
        ...
        for ($u=0; $u < count($c_info); $u++) {
            ...
            if ($c_info[$u]['numero_info'] == 0) {
              if ($c_info[$u]['tipo_info'] == 5) {
                ...
                if 		($ff == $s0) { $finalm0 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s1) { $finalm1 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s2) { $finalm2 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s3) { $finalm3 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s4) { $finalm4 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s5) { $finalm5 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s6) { $finalm6 = nl2br($c_info[$u]['contenido_info']); }
                ...
                if 		($ff == $s0) { $mananaf0 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s1) { $mananaf1 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s2) { $mananaf2 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s3) { $mananaf3 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s4) { $mananaf4 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s5) { $mananaf5 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s6) { $mananaf6 = nl2br($c_info[$u]['contenido_info']); }
              }else{
                if 		($ff == $s0) { $mananat0 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s1) { $mananat1 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s2) { $mananat2 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s3) { $mananat3 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s4) { $mananat4 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s5) { $mananat5 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s6) { $mananat6 = nl2br($c_info[$u]['contenido_info']); }
              }
              ...
              if ($c_info[$u]['tipo_info'] == 5) {
                ...
                if 		($ff == $s0) { $finalt0 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s1) { $finalt1 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s2) { $finalt2 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s3) { $finalt3 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s4) { $finalt4 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s5) { $finalt5 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s6) { $finalt6 = nl2br($c_info[$u]['contenido_info']); }
              }else if ($c_info[$u]['tipo_info'] == 1) {
                ...
                if 		($ff == $s0) { $tardef0 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s1) { $tardef1 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s2) { $tardef2 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s3) { $tardef3 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s4) { $tardef4 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s5) { $tardef5 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s6) { $tardef6 = nl2br($c_info[$u]['contenido_info']); }
              }else{
                if 		($ff == $s0) { $tardet0 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s1) { $tardet1 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s2) { $tardet2 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s3) { $tardet3 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s4) { $tardet4 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s5) { $tardet5 = nl2br($c_info[$u]['contenido_info']); }
                else if ($ff == $s6) { $tardet6 = nl2br($c_info[$u]['contenido_info']); }
              }
            }
        }//FIN FOR
