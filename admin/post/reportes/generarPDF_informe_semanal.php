...
$descripcion_informe_semanal=$_GET["descripcion_informe_semanal"];
  ...
  <main>
    ...
    <div style="width: 100%; background-color: #0b1972; height: 50px; padding: 5px 5px;">
        ...
        <div style="float: right; margin-left: 9px; margin-top: 6px;">
            <p style="text-transform: uppercase; color: white; font-size: 13px; position: relative; top: 4px;"><span style="font-weight: bold;">universidad</span> <span>de chile</span></p>
        </div>

        <div style="float: left; position: relative; top: 3px; margin-right: 10px;">
    ...
    <div class="txCenter div-body" style="box-sizing: border-box; width: 95%; margin: auto; margin-top: -90px;">
        <div style="float: right; margin-left: 9px; margin-top: 6px;">  
        ...
        <div style="margin-top: 0px;/* max-width: 625px; */margin: auto;/* width: 625px; */position: relative;top: 79px;">
            <p style="text-align: center;margin-top: 2px;margin-bottom: 10px;font-size: 15px; color: #4e4e4e; text-align: center;font-weight: bold;color: #8b8b8b;" class="big-text">INFORME SEMANAL</p>
            <div>
                <img src="../../../config/logo_equipo.png" style="top: -25px;height: 100px;width: auto;position: relative;left: 240px;">
            </div>
            <div style="border-top: 2px solid #3c3b3b;border-bottom: 2px solid #3c3b3b;width: 15%;margin: auto;margin-top: 5px;">
        ...
        <div class="span12">
          <div class="modal-body" style="box-sizing: border-box;color:black;font-family:Arial, Helvetica, sans-serif;width: 97%;margin-top: 280px;height: auto;padding: 10px 13px;">
                  <div style="background-color: transparent; width: 99.5%;">
                      ...
                      <div class="right-div-title" style="clear:right"></div>
                      <div style="margin-top:35px;margin-buttom:15px;text-align: left">
                        <div style="clear:both;display:block">
                            <div style="font-size: 15px;color:  #3c3b3b;float:left"><span style="font-weight: bold">Fecha: </span><span style="font-weight: normal">'.$_GET["fecha"].'</span></div>
                        </div>
                        <div style="clear:both;display:block;text-align: left">
                            <div style="margin-top:10px;font-size: 15px;color:  #3c3b3b;float:left"><span style="font-weight: bold">Áreas: </span><span style="font-weight: normal">'.$_GET["areas"].'</span></div>
                        </div>
                        <div style="clear:both;display:block">
                            <div style="margin-top:10px;font-size: 15px;color:  #3c3b3b;float:left"><span style="font-weight: bold">Series: </span><span style="font-weight: normal">'.$_GET["series"].'</span></div>
                        </div>
                      </div>
                      <div style="clear:both;margin-top:60px;">   
                          <textarea id="contenedor_informe" readonly style="padding: 0;height:auto;min-height:500px;width: auto;resize: none;border: solid 2px #e3e3e3;text-align:left;" rows="9">'.$descripcion_informe_semanal.'</textarea>
                      </div>
                  </div> 
          </div>
        </div>
...
$titulo_documento_salida = "[11Analytics]_informe_semanal.pdf";
