...
$datos_informe = buscar_datosPDF( $_POST['idcdp_informe_individual'] );
...
$fecha_cdp_informeindiv = $datos_informe[0]['fecha_cdp_informeindiv'];
$titulo_cdp_informeindiv = $datos_informe[0]['titulo_cdp_informeindiv'];
$informe_cdp_informeindiv = $datos_informe[0]['informe_cdp_informeindiv'];
      ...
      <div class="totalpaginas">
        <div class="txCenter" style="box-sizing: border-box;">
          ...
          <div style="/*background-color: green;*/ position: relative; left: 0px;">
            ...
            <br/><br/>
            <span style="/*background-color:orange;*/ font-size:20px; font-weight:bold;">INFORME INDIVIDUAL</span>                       
          </div>      
...
<main>
        ...
        <div class="totalpaginas">
          <table class="tabla-datos-principales-derecha">
            <tr>
              ...
              <td class="datos-principales">'.$fecha_cdp_informeindiv.'</td>
            </tr>
          </table>   
      ...
      <div class="txCenter wab" style="margin-top:10px;">
        <div class="totalpaginas">
          ...
          <div class="textarea-social txCenter">
            <p class="txCenter" style="margin: 0; font-size:16px;">'.$titulo_cdp_informeindiv.'</p>
          </div>
        </div>
      </div>
    </center> 
    ...
    <center>
      <div class="txCenter wab">
        <div class="totalpaginas">
          ...
          <div class="textarea-social">'.$informe_cdp_informeindiv.'</div>
        </div>
      </div>
    </center>       
  ...
  <footer>
    ...
    <p style="text-align: center; font-weight: bold; margin-top: 10px;">
      CDP '.date("Y").' | Informe Individual ingresado el '.$fecha_software_date.' a las '.$fecha_software_time.'.
    <p>
  </footer>  
</main>
...
$titulo_documento_salida = "[11Analytics]_cdp_informe_individual.pdf";
