...
$descripcion_informe_mensual=$_GET["descripcion_informe_mensual"];
  ...
  <main>
    ...
    <div class="txCenter div-body" style="box-sizing: border-box; width: 95%; margin: auto; margin-top: -90px;">
        ...
        <div style="margin-top: 0px;/* max-width: 625px; */margin: auto;/* width: 625px; */position: relative;top: 79px;">
            <p style="text-align: center;margin-top: 2px;margin-bottom: 10px;font-size: 15px; color: #4e4e4e; text-align: center;font-weight: bold;color: #8b8b8b;" class="big-text">INFORME MENSUAL</p>
            <div>
                ...
                <div style="background-color: transparent; width: 99.5%;">
                    ...
                    <div style="margin-top:35px;margin-bottom:20px">
                        <div style="clear:both;display:block;text-align: left">
                            <span style="font-size: 15px;color:  #3c3b3b;float:left"><span style="font-weight: bold;">Meses: </span><span style="font-weight: normal;">'.$_GET["meses"].'</span></span>
                        </div>
                        <div style="clear:both;display:block;text-align: left">
                            <span style="margin-top:10px;font-size: 15px;color:  #3c3b3b;float:left"><span style="font-weight: bold;">Áreas: </span><span style="font-weight: normal;">'.$_GET["areas"].'</span></span>
                        </div>
                        <div style="clear:both;display:block;text-align: left">
                            <span style="margin-top:10px;font-size: 15px;color:  #3c3b3b;float:left"><span style="font-weight: bold;">Series: </span><span style="font-weight: normal;">'.$_GET["series"].'</span></span>
                        </div>
                    </div>
                    <div style="margin-top:60px;">   
                        <textarea id="contenedor_informe" readonly style="padding: 0;height:auto;min-height:500px;width: auto;resize: none;border: solid 2px #e3e3e3;text-align:left;" rows="9">'.$descripcion_informe_mensual.'</textarea>
                    </div>
                </div> 
        </div>
        </div>
...
$titulo_documento_salida = "[11Analytics]_informe_mensual.pdf";
