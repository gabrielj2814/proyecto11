...
$datos=consultarTestReaccion($_POST["id"]);
$fechaExplotada="";
$listaFilaTabla="";
$fechaInforme="";
if(!empty($datos)){
    $fechaExplotada=explode("-",$datos["fecha_evaluacion_test"]);
...
for($contador=0;$contador<sizeof($datos["detalle_test"]);$contador++){
  ...
  $total=((int)$detalleTestJugador["toma_desicion"])+((int)$detalleTestJugador["presicion"])+((int)$detalleTestJugador["manejo_presion"])+((int)$detalleTestJugador["reaccion"])+((int)$detalleTestJugador["adaptacion"]);
  if($total!==0){
    ...
    <div id="filaBodyTable" style="box-sizing:border-box;border:0;width:90%;height:40px;margin-left:auto;margin-right:auto;background-color:#fff;font-size:13px;color:#555;margin-bottom:1px;">
        ...
        <div  style="box-sizing:border-box;border:0;float:left;height:40px;line-height:25px;/*border-right:1px solid #111;*/width: 13%;" >'.$detalleTestJugador["toma_desicion"].' seg</div>
        <div  style="box-sizing:border-box;border:0;float:left;height:40px;line-height:25px;/*border-right:1px solid #111;*/width: 13%;" >'.$detalleTestJugador["presicion"].' seg</div>
        <div  style="box-sizing:border-box;border:0;float:left;height:40px;line-height:25px;/*border-right:1px solid #111;*/width: 13%;" >'.$detalleTestJugador["manejo_presion"].' seg</div>
        <div  style="box-sizing:border-box;border:0;float:left;height:40px;line-height:25px;/*border-right:1px solid #111;*/width: 13%;" >'.$detalleTestJugador["reaccion"].' seg</div>
        <div  style="box-sizing:border-box;border:0;float:left;height:40px;line-height:25px;/*border-right:1px solid #111;*/width: 13%;" >'.$detalleTestJugador["adaptacion"].' seg</div>
    </div>
    ';
...
$data.= '
  ...
  <main style="padding-top:15px;">
    ...
    <div style="box-sizing:border-box;border:0;width:50%;height:150px;margin-left:auto;margin-right:auto;">
      ...
      <div style="display:block;box-sizing:border-box;border:0;width:375px;height:150px;float:left;text-align:center;color:#555;font-weight: bold;">
          <div style="font-size:35px;margin-top:15px;">TEST DE DECISIÓN</div>
    ...
    <div id="encabezado" style="box-sizing:border-box;border:0;width:90%;height:20px;margin-left:auto;margin-right:auto;background-color:#555;text-transform:uppercase;font-size:15px;color:#fff;font-weight: bold;border-top-left-radius: 5px;border-top-right-radius: 5px;margin-bottom:1px;">
      ...
      <div  style="box-sizing:border-box;border:0;float:left;height:20px;line-height:15px;/*border-right:1px solid #111;*/width: 13%;" >DESICIONES</div>
      <div  style="box-sizing:border-box;border:0;float:left;height:20px;line-height:15px;/*border-right:1px solid #111;*/width: 13%;" >PRECISIÓN</div>
      <div  style="box-sizing:border-box;border:0;float:left;height:20px;line-height:15px;/*border-right:1px solid #111;*/width: 13%;" >PRESIÓN</div>
      <div  style="box-sizing:border-box;border:0;float:left;height:20px;line-height:15px;/*border-right:1px solid #111;*/width: 13%;" >REACCIÓN</div>
      <div  style="box-sizing:border-box;border:0;float:left;height:20px;line-height:15px;/*border-right:1px solid #111;*/width: 13%;" >ADAPTABILIDAD</div>
    </div>
  ...
  <div style="box-sizing: border-box;border: 0;width: 50%;height: 35px;margin-left:auto;margin-right:auto;">
  
  <div style="box-sizing: border-box;border: 0;float:right;padding-left:50px;height: 35px;background-color:#555;color:#fff;text-align:right;margin-left:10px;padding-right:5px;border-radius:5px;font-weight: bold;">'.$datos["promedio_adaptacion"].'</div>
  <div style="box-sizing: border-box;border: 0;float:right;padding-left:50px;height: 35px;background-color:#555;color:#fff;text-align:right;margin-left:10px;padding-right:5px;border-radius:5px;font-weight: bold;">'.$datos["promedio_reaccion"].'</div>
  <div style="box-sizing: border-box;border: 0;float:right;padding-left:50px;height: 35px;background-color:#555;color:#fff;text-align:right;margin-left:10px;padding-right:5px;border-radius:5px;font-weight: bold;">'.$datos["promedio_menejo_presion"].'</div>
  <div style="box-sizing: border-box;border: 0;float:right;padding-left:50px;height: 35px;background-color:#555;color:#fff;text-align:right;margin-left:10px;padding-right:5px;border-radius:5px;font-weight: bold;">'.$datos["promedio_presicion"].'</div>
  <div style="box-sizing: border-box;border: 0;float:right;padding-left:50px;height: 35px;background-color:#555;color:#fff;text-align:right;margin-left:10px;padding-right:5px;border-radius:5px;font-weight: bold;">'.$datos["promedio_toma_desicion"].'</div>
...
$titulo_documento_salida = "[11Analytics]_test_decision.pdf";
