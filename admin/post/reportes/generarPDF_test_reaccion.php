...
$data.= '
  ...
  <main style="padding-top:15px;">
    ...
    <div id="encabezado" style="box-sizing:border-box;border:0;width:90%;height:20px;margin-left:auto;margin-right:auto;background-color:#555;text-transform:uppercase;font-size:15px;color:#fff;font-weight: bold;border-top-left-radius: 5px;border-top-right-radius: 5px;margin-bottom:1px;">
      ...
      <div  style="box-sizing:border-box;border:0;float:left;height:20px;line-height:15px;/*border-right:1px solid #111;*/width: 8%;" >1</div>
      <div  style="box-sizing:border-box;border:0;float:left;height:20px;line-height:15px;/*border-right:1px solid #111;*/width: 8%;" >2</div>
      <div  style="box-sizing:border-box;border:0;float:left;height:20px;line-height:15px;/*border-right:1px solid #111;*/width: 8%;" >3</div>
      <div  style="box-sizing:border-box;border:0;float:left;height:20px;line-height:15px;/*border-right:1px solid #111;*/width: 8%;" >4</div>
      ...
      <div  style="box-sizing:border-box;border:0;float:left;height:20px;line-height:15px;/*border-right:1px solid #111;*/width: 23%;" >COMENTARIO</div>
    </div>
...
$titulo_documento_salida = "[11Analytics]_test_reaccion.pdf";
