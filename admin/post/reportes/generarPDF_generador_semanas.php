...
$fecha_seleccionada = $_POST['inicio'];

$inicioPasado = strtotime('-7 day', strtotime ($_POST['inicio']));
$inicioPasado = date ('Y-m-d', $inicioPasado);
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
$getget = date ('w' , strtotime($inicioPasado));
if ($getget == 1) {
    $inicioPasado = strtotime('+0 day', strtotime($inicioPasado));
}else if ($getget == 2) {
    $inicioPasado = strtotime('-1 day', strtotime($inicioPasado));
}else if ($getget == 3) {
    $inicioPasado = strtotime('-2 day', strtotime($inicioPasado));
}else if ($getget == 4) {
    $inicioPasado = strtotime('-3 day', strtotime($inicioPasado));
}else if ($getget == 5) {
    $inicioPasado = strtotime('-4 day', strtotime($inicioPasado));
}else if ($getget == 6) {
    $inicioPasado = strtotime('-5 day', strtotime($inicioPasado));
}else{
    $inicioPasado = strtotime('-6 day', strtotime($inicioPasado));
}
$inicioPasado = date ('Y-m-d', $inicioPasado);
$_POST['inicio'] = $inicioPasado;
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
$finPasado = strtotime ('+6 day', strtotime ($_POST['inicio']) ) ;
$finPasado = date ('Y-m-d', $finPasado);
$_POST['fin'] = $finPasado;
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
        ...
        for ($k=0; $k < count($c_semana_info); $k++) {
            ...
            if ($c_semana_info[$k]['horario_informe'] == 0) {
                if ($c_semana_info[$k]['categoria_informe'] == 0) {
                    if 		($ff == $s0) { $mananaf0 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s1) { $mananaf1 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s2) { $mananaf2 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s3) { $mananaf3 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s4) { $mananaf4 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s5) { $mananaf5 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s6) { $mananaf6 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                } else if ($c_semana_info[$k]['categoria_informe'] == 1) {
                    if 		($ff == $s0) { $mananat0 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s1) { $mananat1 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s2) { $mananat2 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s3) { $mananat3 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s4) { $mananat4 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s5) { $mananat5 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s6) { $mananat6 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                } else if ($c_semana_info[$k]['categoria_informe'] == 7) {
                    if 		($ff == $s0) { $finalm0 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s1) { $finalm1 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s2) { $finalm2 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s3) { $finalm3 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s4) { $finalm4 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s5) { $finalm5 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s6) { $finalm6 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    ...
                    if 		($ff == $s0) { $mananai0 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s1) { $mananai1 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s2) { $mananai2 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s3) { $mananai3 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s4) { $mananai4 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s5) { $mananai5 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s6) { $mananai6 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                }
            } else if ($c_semana_info[$k]['horario_informe'] == 1) {
                if ($c_semana_info[$k]['categoria_informe'] == 0) {
                    if 		($ff == $s0) { $tardef0 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s1) { $tardef1 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s2) { $tardef2 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s3) { $tardef3 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s4) { $tardef4 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s5) { $tardef5 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s6) { $tardef6 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                }else if ($c_semana_info[$k]['categoria_informe'] == 1){
                    if 		($ff == $s0) { $tardet0 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s1) { $tardet1 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s2) { $tardet2 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s3) { $tardet3 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s4) { $tardet4 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s5) { $tardet5 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s6) { $tardet6 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                } else if ($c_semana_info[$k]['categoria_informe'] == 7) {
                    if 		($ff == $s0) { $finalt0 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s1) { $finalt1 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s2) { $finalt2 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s3) { $finalt3 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s4) { $finalt4 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s5) { $finalt5 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s6) { $finalt6 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                } else if ($c_semana_info[$k]['categoria_informe'] == 5) {
                    ...
                    if 		($ff == $s0) { $tardei0 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s1) { $tardei1 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s2) { $tardei2 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s3) { $tardei3 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s4) { $tardei4 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s5) { $tardei5 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                    else if ($ff == $s6) { $tardei6 = nl2br($c_semana_info[$k]['descripcion_informe']); }
                }
...
$_POST['inicio'] = $fecha_seleccionada;
$inicioPasado = strtotime('+7 day', strtotime ($_POST['inicio']));
$inicioPasado = date ('Y-m-d', $inicioPasado);
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
for ($i = 0; $i <= $semanas; $i++) { 
    ...
    if ($estatusR) {
        ...
        <div class="Helvetica" style="margin-top: 270px;">
            <div style="margin-bottom:15px; background: #D62A1C; height: 20px; border-radius: 2px 2px 2px 2px;"></div>
            <h2 class="txCenter" style="font-size: 30px; font-weight: normal;">Informe Microciclo Calendar</h2>
            <div style="margin-bottom:15px; background: #D62A1C; height: 20px; border-radius: 2px 2px 2px 2px;"></div>
        </div>
