<?php
    ...
    if(!(isset($_SESSION["nombre_usuario_software"]))){
        ...
        $menu_actual="club";
        $submenu_actual="club";
        $seccion_comentarios = $comentarios['club'];//mis cuotas
        $demo_seccion = $demo['club'];
        $nombre_pestana_navegador='Club';
...
<title><?php echo $nombre_pestana_navegador;?> | Club</title>
...
.cuadro_serie_femenino:hover{
    ...
    #tabla_ver_clubes_todos tbody tr {
        text-align: center;
    }

    #tabla_ver_clubes_todos thead tr {
        text-align: center;
    }   
...
#boton_agregar_club:enabled {
    cursor: pointer;
}

#boton_agregar_club:disabled {
    cursor: no-drop;
}
...
// ----------------------- Inicio de la función 'subir_imagen_club()' ----------------------- // 
function subir_imagen_club(){
    var file = document.forms['formulario_club']['foto_club'].files[0];
    ...
    if(!((imagefile==match[0]) || (imagefile==match[1]) || (imagefile==match[2]))){
        ...
        $("#message_foto_club").html("<span id='error_message' style='color:#f76b0e; font-size:10px;'><i class='icon-remove'></i><b>Error:</b> solo formato jpg o png</span>");
        ...
        $("#message_foto_club").html("<span id='error_message' style='color:#f76b0e; font-size:10px;'><i class='icon-remove'></i><b>Error:</b> tamaño máximo 4[mb]</span>");
    }else{
        window.error_foto=4;
        
        $("#message_foto_club").html("");
    }
    return window.error_foto;
}
// ----------------------- Fin de la función 'subir_imagen_club()' ----------------------- //
...
app.controller("controlador_1",['$scope',function($scope){
    ...
    $scope.desactivarBotonAgregarProveedor = function() {
        $('#boton_agregar_club').attr('disabled', true);   
        //$scope.isDisabled = true;
        return false;
    }
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon-truck"></i> CLUB <i class="icon-chevron-right"></i> Club</a>
...
<!-- ========================================== Inicio del id="cuadro_club_main" ========================================== -->
<div id="cuadro_club_main">
...
<div class="row-fluid" style="margin-top:0px;width: 100%;">
    ...
    <div class="span12" style="margin-top: 15px;margin-bottom: 34px;">
        <div style="color:black; font-family:Arial, Helvetica, sans-serif;margin-bottom: 10px">
            <img class="foto-pais-clubpais-tipo1" src="../config/football-club.png" style="width: 60px;position: relative;top: 15px;">
            <p style="left: 10px;margin-top: 0px;display: inline-block;font-weight: bold;font-size: 24px;position: relative;top: 5px; text-transform: uppercase;">Clubes</p>
        </div>                                  
    </div>
    <p class="text-center" style="font-weight: bold; color: black;"><i class="icon-coffee"></i>
        En esta sección puedes crear, visualizar, modifcar y eliminar clubes de fútbol.
    </p> 
    -->

    <table style="color:black; font-family: Arial, Helvetica, sans-serif; margin: 0px auto 10px;">
        <tr class="sin_fondo">
            <td style="padding:12px; padding-top:15px;"><img src="../config/football-club.png" style="height: 100px; margin-top:5px;"></td>
            <td>
                <center>
                    <h3 class="titulo_principal" style="text-transform: uppercase;">Clubes</h3>
                    <p style="margin: 0px;">En esta sección puedes crear, visualizar, modifcar y eliminar clubes de fútbol.</p>                    
                </center>
            </td>
        </tr>
    </table>
...
<!-- ========================================== Fin del class="cuadro_buscar_titulo" ========================================== -->
                        ...
                        <div class="row-fluid cuadro_buscar_buscar" style="margin: 0px; padding:0px; margin-top:30px;">
                            ...
                            <center>
                                <div style=" width:80%; margin-bottom:10px; display: inline-block;">
                                    <!-- ========== FILTRO PARA CLUBES PERTENECIENTES A OTROS PAÍSES -->
                                    <div class="filtros-pais-otros" style="width: 60%;">
                                       <div style="width: 35%;float: left; display: flex;">
                                            <a class="btn btn-md btn-primary green-a" style="width: 45%; text-transform: none;"> 
                                                País
                                            </a>
                                            <select class="green-input select-pais-filtro-busqueda" id="idpais_fbjscouting_main" name="idpais_fbjscouting_main" style="width: 70%;" onchange="buscador();"></select>                             
                                       </div>
                                       <div style="height: 10px; width: 5%; float: left;"></div>
                                       <div style="float: right;width: 60%;">
                                            <input class="ph-center" name="buscar_nombre" style="width:96%; background-color:white; border: 2px solid <?php echo $color_fondo; ?>; margin-bottom:0px;padding-left: 10px; height: 24px;" placeholder="Nombre del Club o Vacío para Ver Todos" maxlength="149" id="buscar_nombre" onkeyup="buscador();" onkeydown="buscador();" >
                                        </div>                      
                                    </div>
                                </div>
                            </center>
                            ...
                            <div class="row-fluid" style="margin-top:0px;">
                                ...
                                <button style="margin-bottom:10px; margin-top: 0px; float:right;" class="boton_informe_jugador" onclick="boton_ir_form_guardar();"><b style="font-size:13px;"><i class="icon-plus"></i> Agregar club</b></button>
                                
                                <div class="span12" style="margin: 0px;">
                                    <table style="border: 0px solid #8f8f8f; width:100%;" id="tabla_ver_clubes_todos">
                                        <thead>
                                            <tr style="background-color:#555555; color:white;">
                                                ...
                                                <th scope="col" style="cursor:pointer; padding:0px; width: 100px; text-align: left;">
                                                    <div class="tip-top" data-original-title="País" style="width:110px;">PAÍS</div>
                                                </th>
                                                <th scope="col" style="cursor:pointer; padding:0px;width: 300px;">
                                                    <div class="tip-top" data-original-title="Nombre" style="width:250px;">NOMBRE</div>
                                                </th>                                                
                                                <th scope="col" style="cursor:pointer; padding:0px;text-align: left; width: 300px;">
                                                    <div class="tip-top" data-original-title="División" style="width:200px;">DIVISIÓN</div>
                                                </th>
                                                <th scope="col" style="cursor:pointer; padding:0px;text-align: center;width: 200px; ">
                                                    <div class="tip-top" data-original-title="Entrenador" style="width:250px;">ENTRENADOR</div>
                                                </th>                                                
...
<div class="row-fluid cuadro_buscar_buscar" style="margin: 0px; padding:0px; margin-top:60px;">
        ...
        <div class="row-fluid" style="margin-top:0px;">
            <div class="span12" style="margin: 0px;">
                <button class="boton_volver" onclick="boton_volver_club_main();" style="float:left; margin:0px; margin-top: 20px;">
        ...
        <div class="row-fluid" style="margin-top:0px;">
            ...
            <div class="span12" style="margin-top: -10px; margin-left: 0;">
                ...
                <!-- ========================================== Inicio del id="formulario_club" ========================================== -->
                <form method="post" ng-model="formulario_club" name="formulario_club" id="formulario_club" novalidate="" class="ng-pristine ng-untouched ng-valid ng-not-empty">
                    ...
                    <div style="width: 100%">
                        ...
                        <div style="width: 40%; float: left; margin-top: 20px;">
                            ...
                            <!--
                            <img src="foto_jugadores/13.png" class="imagen-jugador" style="width: 220px; border-radius: 50%; border: solid #24ac5f 5px; height: 190px; display: block; margin: auto; margin-bottom: 10px;" id="foto-club-img">
                            <div id="div_file">
                                <p id="texto"><i class="icon-cloud-upload"></i> Subir foto (.jpg o png)</p>
                                <input type="file" class="custom-file-input" id="foto_club" name="foto_club" required="" accept=".jpg, .png, .jpeg" onchange="readURL(this);">
                                <input type="hidden" name="foto_anterior_club" id="foto_anterior_club" value="sinFoto">
                            </div>
                            -->

                          <center>
                            <div id="image_preview_club" style="border: 6px solid <?php echo $color_fondo; ?>; width:180px; height:180px;  border-radius:100px;">
                                <img id="foto-club" src="../config/cargando_logo_final.gif" style="width:180px; border-radius:100px; height:180px;" class="img-thumbnail"/>
                            </div>  
                            <label for="foto_club" class="boton_gestionar_cargos subiendo_foto" style="width:170px; margin-top:10px;">
                                <i class="icon-cloud-upload"></i> Subir foto (.jpg o .png)
                            </label>
                            <input type="file" name="foto_club" id="foto_club" value="Seleccionar foto"  style="display:none;"/>
                            <input type="hidden" name="foto_anterior_club" id="foto_anterior_club" value="sinFoto">
                            <div id="message_foto_club">
                            </div>
                          </center>                            
                        ...
                        <div style="width: 60%; float: left;">
                            ...
                            <div>
                                <p style="color: black; font-weight: bold; text-transform: uppercase; text-align: center;">Nuevo club</p>
                            </div>
                           ...
                           <div class="row-form-jugador">
                                <div class="span6" style="display: flex;">
                                    ...
                                    <select class="green-input select-pais-form" id="pais_club" name="pais_club" onchange="get_divisiones_from_pais( 1 );"></select>
                                </div>  
                                <!-- ======================================================================== -->
                                <div class="span6" style="display: flex;">
                                    <a class="btn btn-md btn-primary green-a"> 
                                    ...
                                    <select class="green-input select-division-form" id="division_club" name="division_club" onchange="chequear_datos();">
                           ...
                           <div class="row-form-jugador">
                                <div class="span6" style="display: flex;">
                                    ...
                                    <input class="green-input" name="nombre_club" id="nombre_club" onkeyup="chequear_datos();" onkeydown="chequear_datos();">
                                </div>
                                <!-- ======================================================================== -->
                                <div class="span6" style="display: flex;">
                                    <a class="btn btn-md btn-primary green-a"> 
                                    ...
                                    <input class="green-input" id="entrenador_club" name="entrenador_club" onkeyup="chequear_datos();" onkeydown="chequear_datos();">
                                </div>                                                              
                           </div>
                ...
                <!-- ========================================== Fin del id="formulario_club" ========================================== -->

            </div>

            <div class="span12" style="margin-top: 20px;">
                <center>
                    <button type="submit" class="boton_gestionar_cargos" onclick="boton_guardar_club();" id="boton_agregar_club" disabled="">
...
<div id="modal_formulario_club" class="modal hide" style="border-radius:10px;">
    ...
    <div class="modal-body" style="color:black; font-family:Arial, Helvetica, sans-serif;">
     <center>
      ...
      <div class="modal-footer" style="background-color:<?php echo $color_fondo; ?>; border-bottom-left-radius:10px; border-bottom-right-radius:10px;">
          <center><button type="button" class="btn btn-default boton_modal" data-dismiss="modal" id="boton_cerrar_alerta" style="margin-right:20px; border-radius:5px;"><span class="icon"><i class="icon-remove"></i></span> No</button> <button type="button" class="btn btn-default boton_modal " onClick="guardar_club();" ng-click="desactivarBotonAgregarBoleta()" style="border-radius:5px;"><span class="icon"><i class="icon-ok"></i></span> Si</button> </center>
...
<!-- ========================================================== Inicio del id="uploadImageModalClub" ========================================================== -->
<div id="uploadImageModalClub" class="modal hide" role="dialog" style="border-radius:10px;">
    <div class="modal-header" style="background-color:<?php echo $color_fondo; ?>; border-top-right-radius: 5px; border-top-left-radius: 5px;">
       <button type="button" class="close" data-dismiss="modal">&times;</button>
          <center><h4 class="modal-title"><img src="../config/logo3.png" style="height:30px; width:265px;"></h4></center>
    </div>
    <div class="modal-body" style="color:white; font-family:Arial, Helvetica, sans-serif; background-color:black;">
     <center>
        <div class="imagen_subir_club" id="image_demo_club" style="width:350px; margin-top:10px;"></div>      
        <div class="texto_subir_club" style="margin-top:10px;"></div>    
        <!--<button class="btn btn-success crop_image">USAR ESTA IMAGEN</button>-->     
     </center>
    </div>
      <div class="modal-footer" style="background-color:<?php echo $color_fondo; ?>; border-bottom-left-radius:10px; border-bottom-right-radius:10px;">
          <center>
          <button type="button" id="crop_image_club" class="btn btn-default boton_modal" style="border-radius:5px;"><span class="icon"><i class="icon-ok"></i></span> USAR ESTA IMAGEN</button></center>
    </div>
</div>
<!-- ========================================================== Fin del id="uploadImageModalClub" ========================================================== -->
...
function boton_ir_form_guardar() {
    window.idclub='';
    $('#cuadro_club_main').hide(500);
    $('#cuadro_formulario_guardar').show(500);
    $("#boton_agregar_club").prop("disabled", true); 
    $("#formulario_club")[0].reset();  

    $('#foto_anterior_club').val(''); // <---- Vaciar - IMPORTANTE.
    $('#foto_club').val(''); // <---- Vaciar - IMPORTANTE. 
    $('#foto-club').attr( 'src', '../config/default.png' );

    chequear_datos();

    $("#formulario_club input").each(function(){
        let thisElement = $(this);
        thisElement.css("background-color", "white");
    });
    $("#formulario_club select").each(function(){
        let thisElement = $(this);
        thisElement.css("background-color", "white");
    });
...
// -------------------------- Inicio de la función 'boton_editar( idclub )' - EDITAR (UPDATE) --------------------------- //
function boton_editar( linea ){
    
    $('#foto-club').attr( 'src', '../config/cargando_logo_final.gif' );

    // alert( window.idclub );
    window.idclub = datos_club[linea]['idclub'];

    let pais_club = datos_club[linea]['pais_club'];

    $("#pais_club option").each(function(){
        let thisElement = $(this);
        let thisValue = $(this).val();
        if( thisValue == pais_club ) {
            thisElement.prop("selected", true);
        }
    });

    $("#nombre_club").val( datos_club[linea]['nombre_club'] );

    // División:
    let division_club_element = $('#division_club');
    let division_club = datos_club[linea]['division_club'];
    division_club_element.empty();
    if( division_club === null || division_club == '' || division_club == '0'  ) {

        division_club_element.append('<option value="">Seleccione primero un país</option>');

    } else {

        // Comprobando que el país está en el array de divisiones:
        if (typeof array_divisiones[pais_club] !== 'undefined' && array_divisiones[pais_club] !== null) { 
            // Comprobando que existen divisiones para el país:
            if (typeof array_divisiones[pais_club][division_club] !== 'undefined' && array_divisiones[pais_club][division_club] !== null) { 
                
                let divisiones_pais_selected = array_divisiones[ pais_club ];
                divisiones_pais_selected = divisiones_pais_selected.filter(function(){return true;}); // Reiniciando el valor de los índices de 0 a n.
                division_club_element.append('<option value="">Seleccione</option>');
                for (var i = 0; i < divisiones_pais_selected.length; i++) {
                    let division =  divisiones_pais_selected[i][0];
                    let prop_selected = '';
                    if( division == division_club ) {
                        prop_selected = 'selected'
                    }

                    division_club_element.append('<option '+prop_selected+' value="'+divisiones_pais_selected[i][0]+'">'+divisiones_pais_selected[i][1]+'</option>');
                } 

            }else{
               division_club_element.append('<option value="">No existen divisiones para el país seleccionado</option>');
            }
        }else{
           division_club_element.append('<option value="">No existen divisiones para el país seleccionado</option>');
        }
    ...
    $("#entrenador_club").val( datos_club[linea]['entrenador_club'] );

    let foto_club = 'foto_clubes/' + datos_club[linea]['idclub'] + '.png?lala='+new Date()+'';
    // $('#foto_anterior_club').val( foto_club );
    $('#foto_anterior_club').val( datos_club[linea]['idclub'] + '.png' );
    $('#foto_club').val(''); // <---- Vaciar - IMPORTANTE.
    // $('#foto_club').val( datos_club[linea]['foto_club'] )
    $('#foto-club').attr( 'src', foto_club );
...
// -------------------------- Fin de la función 'boton_editar( idclub )' - EDITAR (UPDATE) --------------------------- //

function boton_eliminar( linea ){
    window.idclub= datos_club[linea]['idclub'];
    // alert( idclub );
    $('#myModal2').modal('show');
    $('#mensaje_eliminar_proveedor').html('<h5>¿Estás seguro que quieres eliminar este club?</h5>*Al borrarlo se perderán todos los datos asociados!<br><img src="../config/remover_archivo.png">');
    $('.boton_modal').show();
}
...
function eliminar() {
    ...
    //alert( window.idclub );
     ...
     $('.boton_modal').hide();
     $('#mensaje_eliminar_proveedor').html('<h5><i class="icon-spinner icon-spin icon-large"></i> Eliminando club...</h5><br><img src="../config/remover_archivo.png">');
     $.ajax({
        url: "post/club_eliminar.php",
        type: "post",
        data: {
            'idclub': window.idclub
...
// ============================== Inicio de la función 'boton_guardar_club()' ============================== //
function boton_guardar_club(){

    if (window.idclub != "" ) {
        $('#mensaje_agregar_club').html('<h5 style="color:black;">¿Estás seguro que quieres editar este registro?</h5><br><img src="../config/agregar_archivo.png">');
    }else{
        $('#mensaje_agregar_club').html('<h5 style="color:black;">¿Estás seguro que quieres agregar este registro?</h5><br><img src="../config/agregar_archivo.png">');
    }
    

    $('#modal_formulario_club').modal('show');
    $('.boton_modal').css('display','');
}
// ============================== Fin de la función 'boton_guardar_club()' ============================== //

// ============================== Inicio de la función 'guardar_club()' ============================== // 
function guardar_club() {
    $('.boton_modal').css('display','none');

    if(window.idclub!=""){
        $('#mensaje_agregar_club').html('<h5><i class="icon-spinner icon-spin icon-large"></i> Editando registro...</h5><br><img src="../config/agregar_archivo.png">');
    }else{
        $('#mensaje_agregar_club').html('<h5><i class="icon-spinner icon-spin icon-large"></i> Agregando registro...</h5><br><img src="../config/agregar_archivo.png">');
    }

    var data = new FormData( $('#formulario_club')[0] );

    data.append('idclub', window.idclub);
    data.append('nombre_usuario_software', '<?php echo utf8_encode($_SESSION["nombre_usuario_software"]);?>');

    // alert(JSON.stringify(data));
    $.ajax({
        url: "post/club_guardar.php",
        type: "post",
            contentType:false,
            data:data,
            processData:false,
        ...
        success: function(respuesta){
            // alert(respuesta);
            if(respuesta==1){
                $('#mensaje_agregar_club').html('<h4>Registro ingresado correctamente!</h4>');
                buscador();
                $("#cuadro_formulario_guardar").hide(500);
                $("#cuadro_club_main").show(500);
                $('#modal_formulario_club').modal('hide');

            }else if(respuesta==2){
                $('#mensaje_agregar_club').html('<h4>Registro editado correctamente!</h4>');
                buscador();
                $("#cuadro_formulario_guardar").hide(500);
                $("#cuadro_club_main").show(500);
                $('#modal_formulario_club').modal('hide');
                ...
                $('#mensaje_agregar_club').html('<h5>Ha ocurrido un error al ejecutar la consulta: '+respuesta+'.</h5><br>');
            }
            
        },error: function(){// will fire when timeout is reached
           $('#mensaje_agregar_club').html('<h5 style="color: #dc4e4e;"><i class="icon-warning-sign"></i> <b>ERROR:</b> compruebe conexión a internet.</h5>');
        }, timeout: 15000 // sets timeout to 3 seconds
    }); 
}
// ============================== Fin de la función 'guardar_club()' ============================== //
...
*/
    ...
    function buscador() {
        ...
        var pais_club = $(".select-pais-filtro-busqueda").val();
        $('#error_conexion').hide();
        $('#sin_resultados').hide();
        $('#cargando_buscar').show();
     
        $.ajax({
            url: "post/club_ver.php",
            type: "post",
            dataType: 'json',
            cache: false,
            data: {
            ...
            if(respuesta== ""){ //jugador sin informes
                $("#tabla_ver_clubes_todos tbody").empty();
                var markup = '<tr class="panel_buscar" style="height:27px;cursor:pointer; color:#555555; font-size:13px;" id="informe_"><td colspan="11"><b>No se encontraron clubes registrados</b></td></tr>';

                var tfoot = '<tr style="background-color:#555555; color:white;"><th scope="col" style="border-bottom-left-radius:5px;padding-top:5px;padding-bottom:5px;min-width:25px;border-bottom-right-radius: 5px;" colspan="10"></th></tr>';

                $("#tabla_ver_clubes_todos tbody").append(markup);

                $("#tabla_ver_clubes_todos tfoot").html(tfoot);
                ...
                window.datos_club = respuesta; //se copian todos los profesores al cache
                $("#tabla_ver_clubes_todos tbody").empty();
                ...
                for(var i=0; i < respuesta.length; i++){
                    ...
                    let division_club = respuesta[i]['division_club'];
                    ...
                    if (typeof array_divisiones[pais_club] !== 'undefined' && array_divisiones[pais_club] !== null) { 
                        // Comprobando que existen divisiones para el país:
                        if (typeof array_divisiones[pais_club][division_club] !== 'undefined' && array_divisiones[pais_club][division_club] !== null) { 
                            division = array_divisiones[pais_club][division_club][1];
                        }else{
                    ...
                    // Bandera del País:
                    let bandera_pais;
                    if( pais_club === null || pais_club == '' || pais_club == '0' ) {
                        bandera_pais = 'src="img/default.png" style="height: 20px; width: 25px; position: relative; top: -2px;"';
                    } else {
                        bandera_pais = 'src="flags/blank.gif" class="flag flag-'+pais_club.toLowerCase()+'"';
                    }

                    var markup = 
                    '<tr style="cursor: pointer;">\
                        <td onclick="boton_editar('+i+');"><b>'+count+'</b></td>\
                        <td onclick="boton_editar('+i+');" class="td-valoracion" style="text-align: left; max-width:110px">\
                            <div class="div-club-table" style="text-align: left;">\
                                <div class="img-next-to-text"><img '+bandera_pais+'></div>\
                                <div><p class="ellipsis-text" style="position: relative; left: 7px; top: 0px;">'+paises_nacionalidad[pais_club]+'</p></div>\
                            </div>\
                        </td>\
                        <td onclick="boton_editar('+i+');" class="td-valoracion" style="text-align: center; padding: 0;">\
                            <div class="div-club-table" style="text-align: left; max-width:250px;">\
                                <div class="img-next-to-text"><img src="'+foto_club+'"></div>\
                                <div><p class="ellipsis-text" style="position: relative; left: 7px; top: 5px;">'+nombre_club+'</p></div>\
                            </div>\
                        </td>\
                        ...
                        <td onclick="boton_editar('+i+');" class="td-valoracion" style="text-align: left; text-align: center;">\
                            <div style="max-width:300px;"><p class="ellipsis-text nombre-club-table">'+entrenador_club+'</p></div>\
                        </td>\
...
function boton_volver_club_main() {
...
function chequear_datos(){
    ...
    // ------------------------------------------------------------------------ //
    let foto_club = $("#foto_club").val();
    var allowedExtensions = /(\.jpg|\.jpeg|\.png)$/i;
    if( foto_club != "" ) {
        if( !allowedExtensions.exec(foto_club) ) {      
    ...
    // ------------------------------------------------------------------------ //
    let pais_club = $("#pais_club").val();
    if( pais_club == "" ) {
        $("#pais_club").css("background-color", "white"); // <--- Color blanco.
        flag = false;
    } else {
        $("#pais_club").css("background-color", "white");
    }

    // ------------------------------------------------------------------------ //
    let nombre_club = $("#nombre_club").val();
    if( nombre_club != "" ) {
        if( nombre_club.match(ER_caracteresAlfaNumericos) && ( parseInt(nombre_club.length) >= 1 && parseInt(nombre_club.length) <= 150 ) ) {      
            $("#nombre_club").css("background-color", "white");
        } else {
            $("#nombre_club").css("background-color", "white");
            flag = false;
        }
    ...
    // ------------------------------------------------------------------------ //
    let division_club = $("#division_club").val();
    if( division_club == "" ) {
        $("#division_club").css("background-color", "white"); // <--- Color blanco.
        // flag = false;
    } else {
        $("#division_club").css("background-color", "white");
    }    

    // ------------------------------------------------------------------------ //
    let entrenador_club = $("#entrenador_club").val();
    if( entrenador_club != "" ) {
        if( entrenador_club.match(ER_caracteresAlfaNumericos) && ( parseInt(entrenador_club.length) >= 1 && parseInt(entrenador_club.length) <= 150 ) ) {      
            $("#entrenador_club").css("background-color", "white");
        } else {
            $("#entrenador_club").css("background-color", "white");
            flag = false;
        }
    ...
    if( flag === false ){
        ...
        $('#boton_agregar_club').prop("disabled", false);
...
function descargarPDF( idclub, titulo_serie_reporte, sexo_seleccion_reporte ){

console.log("ID Intervención Individual: " + idclub );
...
// --------------------------------  Subiendo imagen al club -------------------------------- //
$image_crop_club = $('#image_demo_club').croppie({
...
// Evento onchange desencadenado al seleccionar foto del club:
$('#foto_club').on('change', function(){
  // alert("0");
   $('.boton_modal').show();
  if(subir_imagen_club()==4){ //subir
      var reader = new FileReader();
      reader.onload = function (event) {
        $image_crop_club.croppie('bind', {
      ...
      $('#uploadImageModalClub').modal('show');
  }
});

$('#crop_image_club').click(function(event){
  //alert("1");
  //$('.imagen_subir_club').hide();
  $('#foto-club').attr('src', '../config/cargando_logo_final.gif');
  $('.boton_modal').hide();
  $('.texto_subir_club').html("<br><h3 style='color:white;'><i class='icon-spinner icon-spin icon-large'></i> Subiendo imagen...</h3><br><br><br>");
  $('.texto_subir_club').show();
    $image_crop_club.croppie('result', {
      type: 'canvas',
      size: 'viewport'
          ...
          $.ajax({
            ...
            success:function(data){
              ...
              $('#foto-club').attr('src', data+'?lala='+new Date());
              $('.imagen_subir_club').show();
              $('.texto_subir_club').hide();
              $('#uploadImageModalClub').modal('hide');
            },error: function(){// will fire when timeout is reached
                $('.texto_subir_club').html('<h5 style="color: #dc4e4e;"><i class="icon-warning-sign"></i> <b>ERROR:</b> compruebe conexión a internet.</h5>');
                $('.boton_modal').show();
            }, timeout: 15000 // sets timeout to 3 seconds
          });
...
/*
$("#idpais_fbjscouting_main option[value='0']").remove();
$("#idpais_fbjscouting_main").html($("#idpais_fbjscouting_main option").sort(function (a, b) {
    if(!a.value) return;
    return a.text == b.text ? 0 : a.text < b.text ? -1 : 1
}));
$("#idpais_fbjscouting_main").prepend("<option value='0' selected>Todos</option>");
*/

// Ordenando select de países:
/*
$("#pais_club").html($("#pais_club option").sort(function (a, b) {
    if(!a.value) return;
    return a.text == b.text ? 0 : a.text < b.text ? -1 : 1
}));
$("#pais_club").prepend("<option value=''>Seleccione</option>");
*/
