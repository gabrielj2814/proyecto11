<?php
    ...
    if(!(isset($_SESSION["nombre_usuario_software"]))){
        ...
        $menu_actual="cdp";
        $submenu_actual="cdp_intervencion_grupal";
        $seccion_comentarios = $comentarios['cdp_intervencion_grupal'];//mis cuotas
        $demo_seccion = $demo['cdp_intervencion_grupal'];
        $nombre_pestana_navegador='Intervenciones Grupales';
...
<title><?php echo $nombre_pestana_navegador;?> | Intervenciones Grupales</title>
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon-truck"></i> CDP <i class="icon-chevron-right"></i> Intervenciones Grupales</a>
    ...
    <center>
        ...
        <div class="row-fluid" style="margin-top:0px;">
            <div class="span12" style="margin: 0px;">
                ...
                <input type="hidden" class="serie_cdp_intervgrupal" />
...
<!-- ========================================== Fin del class="cuadro_buscar_titulo" ========================================== -->
                        ...
                        <div class="row-fluid cuadro_buscar_buscar" style="margin: 0px; padding:0px; margin-top: 0px;">
                            ...
                            <div class="row-fluid" style="margin-top:0px;">
                                ...
                                <button style="margin-bottom:10px; margin-top: 0px; float:right;" class="boton_informe_jugador" onclick="boton_agregar_informe_carga();"><b style="font-size:13px;"><i class="icon-plus"></i> NUEVA INTERVENCIÓN</b></button>
                                    ...
                                    <table style="border: 0px solid #8f8f8f; width:100%;" id="tabla_ver_informes_todos">
                                        <thead>
                                            <tr style="background-color:#555555; color:white;">
                                                ...
                                                <th scope="col" style="cursor:pointer; padding:0px; width: 140px; max-width: 140px;">
                                                    <div class="tip-top" data-original-title="Fecha de Intervención" style=" cursor: pointer; padding: 0px; text-align: left;">
                                                        FECHA
                                                    </div>
                                                </th>  
                                                <th scope="col" style="cursor:pointer; padding:0px; width: 650px; max-width: 650px;">
                                                    <div class="tip-top" data-original-title="Objetivos" style=" cursor: pointer; padding: 0px; text-align: left; width: 100%;">
                                                        OBJETIVOS
                                                    </div>
                                                </th>  
                                                <th scope="col" style="cursor:pointer; padding:0px; width: 650px; max-width: 650px;">
                                                    <div class="tip-top" data-original-title="Actividades a realizar" style=" cursor: pointer; padding: 0px; text-align: left; width: 100%;">
        ...
        <div class="row-fluid" style="margin-top:0px;">
            ...
            <div class="span12" style="margin: 0px;">
                ...
                <form method="post" ng-model="formulario" name="formulario" id="formulario" novalidate>
                    ...
                    <input type="hidden" name="serie_cdp_intervgrupal" id="serie_cdp_intervgrupal" class="serie_cdp_intervgrupal" />
                    ...
                    <table style="border: 0px solid #8f8f8f; width:100%;" id="formulario_gestion_talento">
                        ...
                        <tbody>
                            ...
                            <tr class="sin_fondo">
                                <td style="width: 100%; padding: 0px;">
                                    <div class="span12" style="display: flex; width: 100%;">
                                        <a class="btn btn-md btn-primary" style="width: 10%; border-bottom-left-radius:2px; border-top-left-radius:2px; font-size: 13px; background-color:#059c4c; height: 22px;"> Fecha
                                        </a>
                                        <input readonly class="date_fechaNacimiento" type="text" onchange="chequear_datos();" style="width:10%; -webkit-appearance: none; -moz-appearance : none; border: 2px solid #059c4c; border-bottom-right-radius:2px; border-top-right-radius:2px; border-bottom-left-radius:0px; border-top-left-radius:0px; margin-bottom:0px; text-align:center; line-height: 16px;" name="fecha_cdp_intervgrupal" id="fecha_cdp_intervgrupal" />                            
                                    </div>
                                </td>                               
                            </tr>  
                            <!-- ============================================================================================================ -->
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 100%; padding: 0px;">
                                                <div class="span12" style="display: flex; width: 100%;">
                                                    <textarea onkeyup="chequear_datos();" style="resize: none;" class="textarea-social" name="intervdinamica_cdp_intervgrupal" id="intervdinamica_cdp_intervgrupal"></textarea>
                                                </div>
                                            </td>                                                  
                                        </tr>
                                    </tbody>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 100%; padding: 0px;">
                                                <div class="span12" style="display: flex; width: 100%;">
                                                    <textarea onkeyup="chequear_datos();" style="resize: none;" class="textarea-social" name="materiales_cdp_intervgrupal" id="materiales_cdp_intervgrupal"></textarea>
                                                </div>
                                            </td>                                                  
                                        </tr>
                                    </tbody>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 100%; padding: 0px;">
                                                <div class="span12" style="display: flex; width: 100%;">
                                                    <textarea onkeyup="chequear_datos();" style="resize: none;" class="textarea-social" name="objetivos_cdp_intervgrupal" id="objetivos_cdp_intervgrupal"></textarea>
                                                </div>
                                            </td>                                                  
                                        </tr>
                                    </tbody>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 100%; padding: 0px;">
                                                <div class="span12" style="display: flex; width: 100%;">
                                                    <textarea onkeyup="chequear_datos();" style="resize: none;" class="textarea-social" name="actividadrealizar_cdp_intervgrupal" id="actividadrealizar_cdp_intervgrupal"></textarea>
                                                </div>
                                            </td>                                                  
                                        </tr>
                                    </tbody>
                            ...
                            <tr class="sin_fondo" style="color:#555555;">
                                <td style="border-top-left-radius:5px; padding-top:30px; padding-bottom:5px; width: 100%;">
                                    <center>
                                    <button class="boton_volver" onclick="boton_volver_a_serie_selected();" style="float:left; margin:0px;">
                                      <i class="icon-arrow-left"></i> volver
                                    </button>
                                    </center>
                                </td>
...
<script>
    ...
    */
    ...
    function get_cantidad_jugadores_sexo_serie(){
        ...
        $.ajax({
            url: "post/cdp_ver_intervencion_grupal.php",
            type: "post",
            dataType: 'json',
            cache: false,
            data: {
        ...
        $.ajax({
            ...
            success: function(respuesta){
                ...
                if(respuesta== ""){ //jugador sin informes
                    ...
                    window.datos_intervencion_grupal = respuesta; //se copian todos los profesores al cache
                    $("#tabla_ver_perfil_jugador tbody").empty();
                    var count = 1;
...
function boton_ver_perfil_jugador( linea ){
    window.idcdp_intervencion_grupal ='';

    // alert( idfichaJugador + ' - ' + nombre_completo_jugador + ' - ' + edad + ' - ' + numero_posicion );
    $(".idfichaJugador").val( datos_intervencion_grupal[linea]['idfichaJugador'] );
    $(".nombre-jugador").html( datos_intervencion_grupal[linea]['nombre'] + " " + datos_intervencion_grupal[linea]['apellido1'] + " " + datos_intervencion_grupal[linea]['apellido2'] );    

    let posicion = parseInt( datos_intervencion_grupal[linea]['numero_posicion'] );
    switch( posicion ) {
        case 1:
            posicion = "Arquero";
            break;
    ...
    let dinamico = parseInt( datos_intervencion_grupal[linea]['dinamico'] );
    switch( dinamico ) {
        case 0:
            dinamico = "Derecho";
            break;
    ...
    let edad = calcularEdad( datos_intervencion_grupal[linea]['fechaNacimiento'] );
    let datos_jugador = edad + " años, " + posicion + ", Pie " + dinamico;

    $(".datos-jugador").html( datos_jugador );

    // $(".imagen-jugador").attr("src", "foto_jugadores/" + datos_intervencion_grupal[linea]['idfichaJugador'] + '.png');
...
function boton_agregar_informe_carga(){
    ...
    var serie = $('.serie_cdp_intervgrupal').val();
    // alert( serie );
    ...
    $("#fecha_cdp_intervgrupal").val( fecha_actual );    
    $("#serie_cdp_intervgrupal").val( serie );
...
// -------------------------- Inicio de la función 'boton_editar( idcdp_intervencion_grupal )' - EDITAR (UPDATE) --------------------------- //
function boton_editar( linea ){
    
    // alert( window.idcdp_intervencion_grupal );
    window.idcdp_intervencion_grupal = datos_intervencion_grupal[linea]['idcdp_intervencion_grupal'];
    $("#fecha_cdp_intervgrupal").val( datos_intervencion_grupal[linea]['fecha_cdp_intervgrupal'] );
    $("#serie_cdp_intervgrupal").val( datos_intervencion_grupal[linea]['serie_cdp_intervgrupal'] );
    $("#intervdinamica_cdp_intervgrupal").val( datos_intervencion_grupal[linea]['intervdinamica_cdp_intervgrupal'] );
    $("#materiales_cdp_intervgrupal").val( datos_intervencion_grupal[linea]['materiales_cdp_intervgrupal'] );
    $("#objetivos_cdp_intervgrupal").val( datos_intervencion_grupal[linea]['objetivos_cdp_intervgrupal'] );
    $("#actividadrealizar_cdp_intervgrupal").val( datos_intervencion_grupal[linea]['actividadrealizar_cdp_intervgrupal'] );
    // -------------------------------------------------------- //
    $('#cuadro_serie_selected').hide(500);    
    $('#cuadro_formulario_guardar').show(500);
    chequear_datos();
...
// -------------------------- Fin de la función 'boton_editar( idcdp_intervencion_grupal )' - EDITAR (UPDATE) --------------------------- //

function boton_eliminar( linea ){
    window.idcdp_intervencion_grupal= datos_intervencion_grupal[linea]['idcdp_intervencion_grupal'];
    // alert( idcdp_intervencion_grupal );
    $('#myModal2').modal('show');
    $('#mensaje_eliminar_proveedor').html('<h5>¿Estás seguro que quieres eliminar este informe?</h5>*Al borrarlo se perderán todos los datos asociados!<br><img src="../config/remover_archivo.png">');
    $('.boton_modal').show();
}
...
function eliminar_informe() {
    ...
    //alert( window.idcdp_intervencion_grupal );
     ...
     $.ajax({
        url: "post/cdp_eliminar_intervencion_grupal.php",
        type: "post",
        data: {
            'idcdp_intervencion_grupal': window.idcdp_intervencion_grupal
        },success: function(respuesta) {
...
function boton_guardar(){
    // alert( window.idcdp_intervencion_grupal );
    if (window.idcdp_intervencion_grupal != "" ) {
...
function guardar_registro(){
    ...
    data.push({name: 'idcdp_intervencion_grupal',  value: window.idcdp_intervencion_grupal});
    ...
    $.ajax({
        url: "post/cdp_guardar_intervencion_grupal.php",
        type: "post",
        data: data,
        dataType: 'json',
        cache: false,
...
$(".cuadro_serie").click(function(){
    ...
    let serie_cdp_intervgrupal = numero_serie + "_" + sexo;
    $('.serie_cdp_intervgrupal').val( serie_cdp_intervgrupal );
    ...
    function buscador() {
        ...
        var serie_cdp_intervgrupal = $('.serie_cdp_intervgrupal').val();
        ...
        $.ajax({
            ...
            data: {
                ...
                'anio': anio,
                'mes': mes,
                'serie_cdp_intervgrupal': serie_cdp_intervgrupal        
        },success: function(respuesta){
            ...
            if(respuesta== ""){ //jugador sin informes
                ...
                for(var i=0; i < respuesta.length; i++){
                    ...
                    '<tr class="panel_buscar" style="height:27px;cursor:pointer; color:#555555; font-size:13px;">\
                        ...
                        <td class="td-valoracion" onClick="boton_editar('+i+');" style="text-align: left; max-width: 94px; width: 94px;">\
                            <p class="ellipsis-text">\
                                ' + respuesta[i]['fecha_cdp_intervgrupal'] + '\
                            </p>\
                        </td>\
                        <td class="td-valoracion" onClick="boton_editar('+i+');" style="text-align: left; max-width: 250px; width: 250px;">\
                            <p class="ellipsis-text">\
                                ' + respuesta[i]['objetivos_cdp_intervgrupal'] + '\
                            </p>\
                        </td>\
                        <td class="td-valoracion" onClick="boton_editar('+i+');" style="text-align: left; max-width: 250px; width: 250px;">\
                            <p class="ellipsis-text">\
                                ' + respuesta[i]['actividadrealizar_cdp_intervgrupal'] + '\
                            </p>\
                        </td>\
                        <td class="td-valoracion" style="padding: 7px; width: 9px;">\
                            <a class="boton_eliminar" onclick="descargarPDF('+respuesta[i]['idcdp_intervencion_grupal']+', '+titulo_serie+', '+nombre_tecnico+');">\
                                <i class="icon-download-alt"></i>\
                            </a>\
                        </td>\
...
function chequear_datos(){
    ...
    // ------------------------------------------------------------------------ //
    let fecha_cdp_intervgrupal = $("#fecha_cdp_intervgrupal").val();
    if( fecha_cdp_intervgrupal == "" ) {
        $("#fecha_cdp_intervgrupal").css("background-color", "#d4ffdc"); // <--- Color blanco.
        // flag = false;
    } else {
        $("#fecha_cdp_intervgrupal").css("background-color", "#d4ffdc");
    }

    // ------------------------------------------------------------------------ //
    let intervdinamica_cdp_intervgrupal = $("#intervdinamica_cdp_intervgrupal").val();
    if( intervdinamica_cdp_intervgrupal != "" ) {
        if( intervdinamica_cdp_intervgrupal.match(ER_caracteresAlfaNumericos) && ( parseInt(intervdinamica_cdp_intervgrupal.length) >= 1 && parseInt(intervdinamica_cdp_intervgrupal.length) <= 2000 ) ) {      
            $("#intervdinamica_cdp_intervgrupal").css("background-color", "#d4ffdc");
        } else {
            $("#intervdinamica_cdp_intervgrupal").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#intervdinamica_cdp_intervgrupal").css("background-color", "#d4ffdc");
    ...
    // ------------------------------------------------------------------------ //
    let materiales_cdp_intervgrupal = $("#materiales_cdp_intervgrupal").val();
    if( materiales_cdp_intervgrupal != "" ) {
        if( materiales_cdp_intervgrupal.match(ER_caracteresAlfaNumericos) && ( parseInt(materiales_cdp_intervgrupal.length) >= 1 && parseInt(materiales_cdp_intervgrupal.length) <= 2000 ) ) {      
            $("#materiales_cdp_intervgrupal").css("background-color", "#d4ffdc");
        } else {
            $("#materiales_cdp_intervgrupal").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#materiales_cdp_intervgrupal").css("background-color", "#d4ffdc");
    ...
    // ------------------------------------------------------------------------ //
    let objetivos_cdp_intervgrupal = $("#objetivos_cdp_intervgrupal").val();
    if( objetivos_cdp_intervgrupal != "" ) {
        if( objetivos_cdp_intervgrupal.match(ER_caracteresAlfaNumericos) && ( parseInt(objetivos_cdp_intervgrupal.length) >= 1 && parseInt(objetivos_cdp_intervgrupal.length) <= 2000 ) ) {      
            $("#objetivos_cdp_intervgrupal").css("background-color", "#d4ffdc");
        } else {
            $("#objetivos_cdp_intervgrupal").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#objetivos_cdp_intervgrupal").css("background-color", "#d4ffdc");
    ...
    // ------------------------------------------------------------------------ //
    let actividadrealizar_cdp_intervgrupal = $("#actividadrealizar_cdp_intervgrupal").val();
    if( actividadrealizar_cdp_intervgrupal != "" ) {
        if( actividadrealizar_cdp_intervgrupal.match(ER_caracteresAlfaNumericos) && ( parseInt(actividadrealizar_cdp_intervgrupal.length) >= 1 && parseInt(actividadrealizar_cdp_intervgrupal.length) <= 2000 ) ) {      
            $("#actividadrealizar_cdp_intervgrupal").css("background-color", "#d4ffdc");
        } else {
            $("#actividadrealizar_cdp_intervgrupal").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#actividadrealizar_cdp_intervgrupal").css("background-color", "#d4ffdc");
...
function descargarPDF( idcdp_intervencion_grupal, titulo_serie, nombre_tecnico ){

console.log("ID Intervención Grupal: " + idcdp_intervencion_grupal );
...
$('#mensaje_agregar_descargarPDF').html('<h5><i class="icon-spinner icon-spin icon-large"></i> Generando PDF...</h5><br><img src="../config/agregar_archivo.png">');
    ...
    $.ajax({
        url: "post/reportes/generarPDF_cdp_intervgrupal.php",
        type: "post",
        data: {
            idcdp_intervencion_grupal,
            titulo_serie,
            nombre_tecnico          
        },
        dataType: 'json',
