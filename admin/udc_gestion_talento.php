<?php
    ...
    if(!(isset($_SESSION["nombre_usuario_software"]))){
        ...
        $menu_actual="udc";
        $submenu_actual="udc_gestion_talento";
        $seccion_comentarios = $comentarios['udc_gestion_talento'];//mis cuotas
        $demo_seccion = $demo['udc_gestion_talento'];
        $nombre_pestana_navegador='Gestión de Talentos';
...
<title><?php echo $nombre_pestana_navegador;?> | Gestión de Talentos</title>
...
<div class="row-fluid" style="margin-top: 0px; color:black; font-family:Arial, Helvetica, sans-serif;" id="cuadro_listado_series"> 
    ...
    <table style="color:black; font-family: Arial, Helvetica, sans-serif; margin: 0px auto 10px;">
        <tr class="sin_fondo">
            ...
            <td>
                <center>
                    <h3 class="titulo_principal">GESTIÓN DE TALENTOS</h3>
                    <p style="margin: 0px;">En esta sección puedes crear, visualizar, modifcar y eliminar datos relacionados a la gestión de talentos de los jugadores</p>                    
                </center>
            </td>
        </tr>
    </table>
...
<table style="color: black; font-family: Arial, Helvetica, sans-serif; margin: 0px auto 10px;">
      ...
      <input class="tecnico" type="hidden">  
                                ...
                                <td style="text-align: center;">
                                    <h3 class="titulo_principal" style="margin: 0px; line-height: 26px;">GESTIÓN DE TALENTOS</h3>
                    ...
                    <thead>
                        <tr style="background-color:#555555; color:white;">
                            ...
                            <th scope="col" style="cursor:pointer; padding:0px; width: 100px;">
                                <div class="tip-top" data-original-title="Fecha" style="width:100%; text-align: center;">FECHA</div>
                            </th>
                            <th scope="col" style="cursor:pointer; padding:0px; width: 200px;">
                                <div class="tip-top" data-original-title="Status del Jugador" style="width:220px; text-align: center;">STATUS JUGADOR</div>
                            </th>                                                
                            <th scope="col" style="cursor:pointer; padding:0px; width: 650px;">
                                <div class="tip-top" data-original-title="Aspectos a mejorar" style="width:100%; text-align: left;">ASPECTOS A MEJORAR</div>
                            </th>
        ...
        <div class="row-fluid cuadro_buscar_buscar" style="margin: 0px; padding:0px; margin-top:-60px;">
            <div class="row-fluid" style="margin-top:0px;">
                ...
                <div class="span12" style="margin: 0px;">
                    ...
                    <!-- ========================================== Inicio del id="tabla_sociologia" ========================================== -->
                    <table style="border: 0px solid #8f8f8f; width:100%;" id="tabla_sociologia">
                                            
                        <tbody>
                            <!-- ============================================================================================================ -->
                            <tr class="sin_fondo" style="color:#555555;">
                                <td style="border-top-left-radius:5px; padding-top:5px; padding-bottom:5px; width: 100%;">
                                    <h5 class="titulo-campo-talento">- Ecosistema Social</h5>
                                </td>
                            </tr>
                            <!-- ============================================================================================================ -->
                            <tr class="sin_fondo" style="color:#555555;">
                                <td style="border-top-left-radius:5px; padding-top:5px; padding-bottom:5px; width: 100%;">
                                    <h5 class="titulo-campo-talento">Estudios mesosociales</h5>
                                </td>
                            </tr>
                            <!-- ============================================================================================================ -->
                            <tr class="sin_fondo">
                                <td style="width: 100%; padding: 0px;">
                                    <div class="span12" style="display: flex; width: 100%;">
                                        <textarea onkeyup="chequear_datos();" style="resize: none;" class="textarea-social" name="estudios_mesosociales" id="estudios_mesosociales"></textarea>
                                    </div>
                                </td>                               
                            </tr> 
                            <!-- ============================================================================================================ -->
                            <tr class="sin_fondo" style="color:#555555;">
                                <td style="border-top-left-radius:5px; padding-top:5px; padding-bottom:5px; width: 100%;">
                                    <h5 class="titulo-campo-talento">Estudios microsociales</h5>
                                </td>
                            </tr>
                            <!-- ============================================================================================================ -->
                            <tr class="sin_fondo">
                                <td style="width: 100%; padding: 0px;">
                                    <div class="span12" style="display: flex; width: 100%;">
                                        <textarea onkeyup="chequear_datos();" style="resize: none;" class="textarea-social" name="estudios_microsociales" id="estudios_microsociales"></textarea>
                                    </div>
                                </td>                               
                            </tr> 
                            <!-- ============================================================================================================ -->                            
...
<script>
    ...
    */
    ...
    function get_cantidad_jugadores_sexo_serie(){
        ...
        $.ajax({
            url: "post/udc_ver_gestion_talento.php",
            type: "post",
            dataType: 'json',
            cache: false,
            data: {
            ...
            success: function(respuesta){
                ...
                if(respuesta== ""){ //jugador sin informes
                    ...
                    for(var i=0; i < respuesta.length; i++){              
                        ...
                        let idudc_gestion_talento = respuesta[i]['idudc_gestion_talento'];

                        // Status:
                        let status_talento_descripcion = ""
                        switch( respuesta[i]['status_talento'] ) {
                            case "0":
                                status_talento_descripcion = 'Jugador seleccionable';
                                break;

                            case "1":
                                status_talento_descripcion = 'Jugador pre seleccionable';
                                break;

                            case "2":
                                status_talento_descripcion = 'Jugador en desarrollo';
                                break;                                                                
                        }


                        let fecha_talento = respuesta[i]['fecha_talento'];
                        
                        // Día:
                        let dia_talento = fecha_talento.substring(8, 10); 

                        // Mes:
                        let mes_talento = fecha_talento.substring(5, 7);     

                        // Año:
                        let anio_talento = fecha_talento.substring(0, 4); 

                        fecha_talento = dia_talento + "-" + mes_talento + "-" + anio_talento;

                        var markup = 
                        '<tr class="panel_buscar" style="height:27px;cursor:pointer; color:#555555;">\
                            <td onclick="boton_editar('+i+', 2)"><b>'+count+'</b>\
                                <input type="hidden" value="'+ respuesta[i]['idfichaJugador'] +'" name="id_ficha_jugador[]" />\
                            </td>\
                            <td onclick="boton_editar('+i+', 2)" style="text-align: center;"><b>'+fecha_talento+'</b>\
                            </td>\
                            <td onclick="boton_editar('+i+', 2)" class="td-valoracion" style="text-align: center;">\
                                '+status_talento_descripcion+'\
                            </td>\
                            <td onclick="boton_editar('+i+', 2)" class="td-valoracion" style="text-align: left;">\
                                '+respuesta[i]['aspectos_mejorar_talento']+'\
                            </td>\
                            <td style="padding: 7px;">\
                                <a class="boton_add" onclick="descargarPDF('+idudc_gestion_talento+');">\
                                    <i class="icon-download-alt"></i>\
                                </a>\
                            </td>\
                            <td style="padding: 7px;">\
                                <a class="boton_editar" onClick="boton_editar('+i+');">\
...
// -------------------------- Inicio de la función 'boton_editar( idudc_gestion_talento )' - EDITAR (UPDATE) --------------------------- //
function boton_editar( linea, vista ){
    
    window.idudc_gestion_talento = datos_visita_social[linea]['idudc_gestion_talento'];
    // alert( window.idudc_gestion_talento );
    ...
    let posicion = parseInt( datos_visita_social[linea]['numero_posicion'] );
    switch( posicion ) {
        case 1:
            posicion = "Arquero";
            break;
    ...
    let dinamico = parseInt( datos_visita_social[linea]['dinamico'] );
    switch( dinamico ) {
        case 0:
            dinamico = "Derecho";
            break;
    ...
    $('#cargando_buscar').show();
     ...
     $.ajax({
            ...
            data: {
            'tipo_consulta': 3,
            'idudc_gestion_talento': idudc_gestion_talento,
        },success: function(respuesta){
            // alert(JSON.stringify(respuesta));
            if(respuesta== ""){ //jugador sin informes
                $("#tabla_ver_informes tbody").empty();
                var markup = '<tr class="panel_buscar" style="height:27px;cursor:pointer; color:#555555;" id="informe_"><td colspan="6"><center><b>No existen jugadores registrados en este serie...</b></center></td></tr>';
                ...
                for(var i=0; i < respuesta.length; i++) {
                    ...
                    $('#idfichaJugador').val( respuesta[i]['idfichaJugador'] );
                    $('#fecha_talento').val( respuesta[i]['fecha_talento'] );
                    $('#perfil_comunicacional_talento').val( respuesta[i]['perfil_comunicacional_talento'] );
                    $('#reputacion_deportiva_talento').val( respuesta[i]['reputacion_deportiva_talento'] );
                    $('#redes_sociales_talento').val( respuesta[i]['redes_sociales_talento'] );                    
                    $('#aspectos_mejorar_talento').val( respuesta[i]['aspectos_mejorar_talento'] );
                    $('#actividades_realizar_talento').val( respuesta[i]['actividades_realizar_talento'] );
                    

                    $("#status_talento option").each(function(){
                        let thisElement = $(this);
                        let thisValue = $(this).val();
                        if( thisValue == respuesta[i]['status_talento'] ) {
                            thisElement.prop("selected", true);
                        }
                    });

                    $('#estudios_mesosociales').val( respuesta[i]['estudios_mesosociales'] );
                    $('#estudios_microsociales').val( respuesta[i]['estudios_microsociales'] );
...
// -------------------------- Fin de la función 'boton_editar( idudc_gestion_talento )' - EDITAR (UPDATE) --------------------------- //

function boton_eliminar( linea ){
    window.idudc_gestion_talento= datos_visita_social[linea]['idudc_gestion_talento'];
    // alert( idudc_gestion_talento );
    $('#myModal2').modal('show');
    $('#mensaje_eliminar_proveedor').html('<h5>¿Estás seguro que quieres eliminar este informe?</h5>*Al borrarlo se perderán todos los datos asociados!<br><img src="../config/remover_archivo.png">');
    $('.boton_modal').show();
}
...
function eliminar_informe() {
    ...
    //alert( window.idudc_gestion_talento );
     ...
     $.ajax({
        url: "post/udc_eliminar_gestion_talento.php",
        type: "post",
        data: {
            'idudc_gestion_talento': window.idudc_gestion_talento
        },success: function(respuesta) {
...
function boton_guardar(){
    // alert( window.idudc_gestion_talento );
    if (window.idudc_gestion_talento != "" ) {
...
function guardar_registro(){
    ...
    data.push({name: 'idudc_gestion_talento',  value: window.idudc_gestion_talento});
    ...
    $.ajax({
        url: "post/udc_guardar_gestion_talento.php",
        type: "post",
        data: data,
        dataType: 'json',
        cache: false,
            ...
            if(respuesta== ""){ //jugador sin informes
                ...
                for(var i=0; i < respuesta.length; i++){
                    ...
                    */
                    ...
                    // alert( respuesta[i]['idudc_gestion_talento'] );
                    if( typeof respuesta[i]['idudc_gestion_talento'] === 'undefined' ) {
                        ...
                        '<tr class="panel_buscar tr_posicion_jugador_'+posicion0+'" style="height:0px; cursor:pointer; color:#555555;" num-grupo-posicion="'+num_grupo_posicion+'" nombre-grupo-posicion="'+nombre_grupo_posicion+'">\
                            ...
                            <td onClick="boton_ver_perfil_jugador('+i+');" style="text-align: left;">\
                                ...
                                <div style="max-width: 300px;">\
                                    <p class="ellipsis-text" style="position: relative; top: 3px; left: 7px; color: black;">' + nombre_completo_jugador + '</p>\
                                </div>\
                            </td>\
                        ...
                        /*
                        let class_tr_status = "";
                        if( respuesta[i]['status_talento'] == "0" ) {
                            class_tr_status = "panel_buscar_claro";
                            //style_attr_status = 'style="height:27px; cursor:pointer; background-color: #ffcd43; color:#555555; font-size:13px;"';
                        } 
                        */

                        /*
                        '<tr class="panel_buscar '+class_tr_status+'" num-grupo-posicion="'+num_grupo_posicion+'" nombre-grupo-posicion="'+nombre_grupo_posicion+'">\
                            <td onClick="boton_ver_perfil_jugador('+i+');" style="font-weight:bold;"><b>'+count+'</b>\
                        */ 
                        var markup = 
                        '<tr class="panel_buscar tr_posicion_jugador_'+posicion0+'" num-grupo-posicion="'+num_grupo_posicion+'" nombre-grupo-posicion="'+nombre_grupo_posicion+'">\
                            ...
                            <td onClick="boton_ver_perfil_jugador('+i+');" style="padding: 7px;">\
                                <i class="icon-paper-clip"></i> <b>('+respuesta[i]['cantidad_informes_gestion_talento']+') informes</b>\
                            </td>\
                        </tr>';
...
function chequear_datos(){
    ...
    // ------------------------------------------------------------------------ //
    let perfil_comunicacional_talento = $("#perfil_comunicacional_talento").val();
    if( perfil_comunicacional_talento != "" ) {
        if( perfil_comunicacional_talento.match(ER_caracteresAlfaNumericos) && ( parseInt(perfil_comunicacional_talento.length) >= 1 ) ) {      
            $("#perfil_comunicacional_talento").css("background-color", "white");
        } else {
            $("#perfil_comunicacional_talento").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#perfil_comunicacional_talento").css("background-color", "#fff");
        // flag = false;
    }

    // ------------------------------------------------------------------------ //
    let reputacion_deportiva_talento = $("#reputacion_deportiva_talento").val();
    if( reputacion_deportiva_talento != "" ) {
        if( reputacion_deportiva_talento.match(ER_caracteresAlfaNumericos) && ( parseInt(reputacion_deportiva_talento.length) >= 1 ) ) {      
            $("#reputacion_deportiva_talento").css("background-color", "white");
        } else {
            $("#reputacion_deportiva_talento").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#reputacion_deportiva_talento").css("background-color", "#fff");
        // flag = false;
    }

    // ------------------------------------------------------------------------ //
    let redes_sociales_talento = $("#redes_sociales_talento").val();
    if( redes_sociales_talento != "" ) {
        if( redes_sociales_talento.match(ER_caracteresAlfaNumericos) && ( parseInt(redes_sociales_talento.length) >= 1 ) ) {      
            $("#redes_sociales_talento").css("background-color", "white");
        } else {
            $("#redes_sociales_talento").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#redes_sociales_talento").css("background-color", "#fff");
        // flag = false;
    }
        
    // ------------------------------------------------------------------------ //
    let aspectos_mejorar_talento = $("#aspectos_mejorar_talento").val();
    if( aspectos_mejorar_talento != "" ) {
        if( aspectos_mejorar_talento.match(ER_caracteresAlfaNumericos) && ( parseInt(aspectos_mejorar_talento.length) >= 1 ) ) {      
            $("#aspectos_mejorar_talento").css("background-color", "white");
        } else {
            $("#aspectos_mejorar_talento").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#aspectos_mejorar_talento").css("background-color", "#fff");
        // flag = false;
    }

    // ------------------------------------------------------------------------ //
    let actividades_realizar_talento = $("#actividades_realizar_talento").val();
    if( actividades_realizar_talento != "" ) {
        if( actividades_realizar_talento.match(ER_caracteresAlfaNumericos) && ( parseInt(actividades_realizar_talento.length) >= 1 ) ) {      
            $("#actividades_realizar_talento").css("background-color", "white");
        } else {
            $("#actividades_realizar_talento").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#actividades_realizar_talento").css("background-color", "#fff");
        // flag = false;
    }

    // ------------------------------------------------------------------------ //
    let status_talento = $("#status_talento").val();
    if( status_talento == "" ) {
        $("#status_talento").css("background-color", "#fff"); // <--- Color blanco.
        flag = false;
    } else {
        $("#status_talento").css("background-color", "#fff");
    }   

    // ------------------------------------------------------------------------ //
    let estudios_mesosociales = $("#estudios_mesosociales").val();
    if( estudios_mesosociales != "" ) {
        if( estudios_mesosociales.match(ER_caracteresAlfaNumericos) && ( parseInt(estudios_mesosociales.length) >= 1 ) ) {      
            $("#estudios_mesosociales").css("background-color", "white");
        } else {
            $("#estudios_mesosociales").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#estudios_mesosociales").css("background-color", "#fff");
        // flag = false;
    }

    // ------------------------------------------------------------------------ //
    let estudios_microsociales = $("#estudios_microsociales").val();
    if( estudios_microsociales != "" ) {
        if( estudios_microsociales.match(ER_caracteresAlfaNumericos) && ( parseInt(estudios_microsociales.length) >= 1 ) ) {      
            $("#estudios_microsociales").css("background-color", "white");
        } else {
            $("#estudios_microsociales").css("background-color", "#ffc6c6");
            flag = false;
        }
    } else {
        $("#estudios_microsociales").css("background-color", "#fff");
        // flag = false;
    }    
...
function descargarPDF( idudc_gestion_talento ){
