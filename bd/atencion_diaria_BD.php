...
function consultarJugador($get){
    ...
    // SELECT * FROM fichaJugador,club WHERE (fichaJugador.serieActual='99' AND fichaJugador.sexo="1" );
    $SQL="SELECT * FROM fichaJugador WHERE (fichaJugador.serieActual='".$get["serie"]."' AND fichaJugador.sexo=".$get["sexo"]." );";
    // $SQL="SELECT * FROM fichajugador,club WHERE (fichajugador.serieActual='".$get["serie"]."' AND fichajugador.sexo=".$get["sexo"]." ) AND fichajugador.idclub=club.idclub ;";
...
function registrarTratamientoAtencionDiaria($POST,$tratamiento,$id_atencion_diaria){
    include("conexion.php");
    $fecha_software=date_futbolJoven();
    $SQL="INSERT INTO tratamiento_aplicado_atencion_diaria(nombre_tratamiento_atencion_diaria,idatencion_diaria,fecha_software,nombre_usuario_software) VALUES('".$tratamiento."',".$id_atencion_diaria.",'".$fecha_software."','".$POST["nombre_usuario_software"]."');";
    $link->query($SQL);
    $link->close();
    return ["respuesta" => true];
}
...
function registrarExamenesSolicitadosAtencionDiaria($POST,$examen,$id_atencion_diaria){
    include("conexion.php");
    $fecha_software=date_futbolJoven();
    $SQL="INSERT INTO examen_solicitado_atencion_diaria(nombre_examen_atencion_diaria,idatencion_diaria,fecha_software,nombre_usuario_software) VALUES('".$examen."',".$id_atencion_diaria.",'".$fecha_software."','".$POST["nombre_usuario_software"]."');";
    $link->query($SQL);
    $link->close();
    return ["respuesta" => true];
}
...
function registrarTrabajoRedaptorAtencionDiaria($POST,$trabajo_readaptador,$id_atencion_diaria){
    include("conexion.php");
    $fecha_software=date_futbolJoven();
    $SQL="INSERT INTO trabajo_readaptador_atencion_diaria(idatencion_diaria,trabajo_readaptador_atencion_diaria,fecha_software,nombre_usuario_software) VALUES(".$id_atencion_diaria.",".$trabajo_readaptador.",'".$fecha_software."','".$POST["nombre_usuario_software"]."');";
    $link->query($SQL);
    $link->close();
}
...
function registrarRecomendacionesAltaAtencionDiaria($POST,$recomendacion_alta,$id_atencion_diaria){
    include("conexion.php");
    $fecha_software=date_futbolJoven();
    $SQL="INSERT INTO recomendacion_alta_atencion_diaria(idatencion_diaria,recomendacion_alta_atencion_diaria,fecha_software,nombre_usuario_software) VALUES(".$id_atencion_diaria.",".$recomendacion_alta.",'".$fecha_software."','".$POST["nombre_usuario_software"]."');";
    $link->query($SQL);
    $link->close();
}
...
function registrarAltaDeportiva($POST,$alta_deportiva,$id_atencion_diaria){
    include("conexion.php");
    $fecha_software=date_futbolJoven();
    $SQL="INSERT INTO alta_deportiva_atencion_diaria(idatencion_diaria,alta_deportiva_atencion_diaria,fecha_software,nombre_usuario_software) VALUES(".$id_atencion_diaria.",".$alta_deportiva.",'".$fecha_software."','".$POST["nombre_usuario_software"]."');";
    $link->query($SQL);
    $link->close();
}
...
function registrarLesionesCuerpo($POST,$codigo,$parte_texto,$id_atencion_diaria){
    include("conexion.php");
    $fecha_software=date_futbolJoven();
    $SQL="INSERT INTO zonas_lesion_atencion_diaria(idatencion_diaria,codigo_zonas_lesion,zona_lesion,fecha_software,nombre_usuario_software) VALUES(".$id_atencion_diaria.",'".$codigo."','".$parte_texto."','".$fecha_software."','".$POST["nombre_usuario_software"]."');";
    // print($SQL);
    $link->query($SQL);
    $link->close();
}
    ...
    if($POST["tipo_formulario"]==="1"){
        if($POST["id_informe"]=="false"){
            ...
            $SQL="UPDATE atencion_diaria SET
                ...
                WHERE idatencion_diaria=".$POST["id_atencion_diaria"].";";
            // print($SQL);
            $link->query($SQL);
            $link->close();
...
function consultarAtencionDiariaJugador($POST){
    include("conexion.php");
    $SQL_atencion_diaria="SELECT * FROM  fichaJugador,atencion_diaria WHERE  (atencion_diaria.fecha_atencion_diaria BETWEEN '".$POST["fecha_inicio"]."' AND '".$POST["fecha_final"]."'  ) AND ( fichaJugador.nombre LIKE '%".$POST["nombre_jugador"]."%' AND  fichaJugador.idfichaJugador=atencion_diaria.idfichaJugador  )  ";
    ...
    for($contador3=0;$contador3<sizeof($datos_atencion_diaria);$contador3++){
        $SQL_examen_solicitud="SELECT * FROM examen_solicitado_atencion_diaria WHERE idatencion_diaria=".$datos_atencion_diaria[$contador3]["idatencion_diaria"]."";
        ...
        $SQL_tratamiento_aplicado="SELECT * FROM tratamiento_aplicado_atencion_diaria WHERE idatencion_diaria=".$datos_atencion_diaria[$contador3]["idatencion_diaria"]."";
        ...
        $SQL_tranajo_readaptor="SELECT * FROM trabajo_readaptador_atencion_diaria WHERE idatencion_diaria=".$datos_atencion_diaria[$contador3]["idatencion_diaria"]."";
        ...
        $SQL_recomendaciones_alta="SELECT * FROM recomendacion_alta_atencion_diaria WHERE idatencion_diaria=".$datos_atencion_diaria[$contador3]["idatencion_diaria"]."";
        ...
        $SQL_alta_deportiva="SELECT * FROM alta_deportiva_atencion_diaria WHERE idatencion_diaria=".$datos_atencion_diaria[$contador3]["idatencion_diaria"]."";
        ...
        $SQL_lesion="SELECT * FROM zonas_lesion_atencion_diaria WHERE idatencion_diaria=".$datos_atencion_diaria[$contador3]["idatencion_diaria"]."";
...
function eliminarAtencionDiariaExamenes($POST){
    include("conexion.php");
    $SQL="DELETE FROM examen_solicitado_atencion_diaria WHERE idatencion_diaria=".$POST["id_atencion_diaria"].";";
    $link->query($SQL);
    // print($SQL);
    $link->close();
}
...
function eliminarAtencionDiariaTratamiento($POST){
    include("conexion.php");
    $SQL="DELETE FROM tratamiento_aplicado_atencion_diaria WHERE idatencion_diaria=".$POST["id_atencion_diaria"].";";
    $link->query($SQL);
    // print($SQL);
    $link->close();
}
...
function eliminarAtencionDiariaTrabajoReadaptador($POST){
    include("conexion.php");
    $SQL="DELETE FROM trabajo_readaptador_atencion_diaria WHERE idatencion_diaria=".$POST["id_atencion_diaria"].";";
    $link->query($SQL);
    // print($SQL);
    $link->close();
}
...
function eliminarAtencionDiariaAltaDeportiva($POST){
    include("conexion.php");
    $SQL="DELETE FROM alta_deportiva_atencion_diaria WHERE idatencion_diaria=".$POST["id_atencion_diaria"].";";
    $link->query($SQL);
    // print($SQL);
    $link->close();
}
...
function eliminarAtencionDiariaRecomendacionAlta($POST){
    include("conexion.php");
    $SQL="DELETE FROM recomendacion_alta_atencion_diaria WHERE idatencion_diaria=".$POST["id_atencion_diaria"].";";
    $link->query($SQL);
    // print($SQL);
    $link->close();
}
...
function eliminarAtencionDiariaLesiones($POST){
    include("conexion.php");
    $SQL="DELETE FROM zonas_lesion_atencion_diaria WHERE idatencion_diaria=".$POST["id_atencion_diaria"].";";
    $link->query($SQL);
    // print($SQL);
    $link->close();
}
...
function consultarAtencionPdf($id){
    ...
    include("conexion.php");
    $SQL="SELECT * FROM atencion_diaria,fichaJugador WHERE atencion_diaria.idatencion_diaria=".$id." AND fichaJugador.idfichaJugador=atencion_diaria.idfichaJugador;";
    $result_atencion=$link->query($SQL);
    $datos=[];
    while($row_atencion_diaria=mysqli_fetch_array($result_atencion)){

        $SQL_tratamiento_aplicado="SELECT * FROM tratamiento_aplicado_atencion_diaria WHERE  idatencion_diaria=".$row_atencion_diaria["idatencion_diaria"].";";
        ...
        $SQL_recomendacion="SELECT * FROM recomendacion_alta_atencion_diaria WHERE  idatencion_diaria=".$row_atencion_diaria["idatencion_diaria"].";";
